...
L.core = {
	...
	options = {
		...
		mouseover = "Scan on MouseOver",
		mouseoverDesc = "Automatically scans players on mouseover. May add major UI lag in cities and you will hit the inspecting rate limit.",
		purge = "Purge Cache",
		...
		round = "Round iLevel",
		roundDesc = "Round the iLevel to the nearest whole number",
