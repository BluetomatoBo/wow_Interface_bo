...
L.RaidWarnMessage 			= "感謝您使用Voice Encounter Mods"
...
L.SpecWarn_FlashFrame		= "特別警告時屏幕邊緣泛光"
L.SpecWarn_ShakeFrame		= "為毀滅性技能閃爍屏幕"
L.SpecWarn_AdSound			= "啓用特別警告高級聲音選項（需要UI重載）"
L.Area_SpecWarnFlash		= "特別警告泛光選項"
L.SpecWarn_FlashColor		= "泛光顏色"
...
L.SpamBlockBossWhispers			= "當戰鬥時過濾 <VEM> 密語警告"
