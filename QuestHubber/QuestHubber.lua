...
local dataObj = ldb:NewDataObject("QuestHubber", {
	...
	OnTooltipShow = function(self)
		...
		self:AddLine(" ")
		self:AddLine("|cFFEDA55FClick|r to open the World Map", 0.2, 1, 0.2, 1)
...
function core:SetupMapModule()
	...
	frame:SetPoint("TOPLEFT", WorldMapDetailFrame, "TOPLEFT", 5, -2);
	frame:Hide();
	frame:EnableMouse(1);
	...
	core.mapModule.SetCount = function(self, m, n)
		...
		self.text:SetText("QuestHubber " .. suffix)
