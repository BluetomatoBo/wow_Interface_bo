...
function AS:UpdateLocale_itIT()
	...
	ASL["FAQ's"] = "FAQ";
	ASL["[Q] DBM/VEM Half-Bar Skin Spacing looks wrong. How can I fix it?"] = "[D] Lo spazio dell'aspetto Mezza Barra di DBM/VEM non è visualizzato correttamente. Come posso aggiustarlo?";
	ASL["[A] To use the DBM/VEM Half-Bar skin. You must change the DBM/VEM Options. Offset Y needs to be at least 15."] = "[R] Per visualizzare correttamente l'aspetto Mezza Barra di DBM/VEM devi cambiare le relative Opzioni.\nL'Offset Y deve essere impostato almeno su 15.";
	ASL["Credits"] = "Crediti";
	ASL["Credits:"] = "Crediti:";
