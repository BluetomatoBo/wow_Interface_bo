-- $Id: crafting.lua 4212 2013-05-20 12:27:56Z dynaletik $
...
---- Jewelcrafting Daily
	...
	AtlasLoot_Data["SmithingArmorMoP"] = {
		["Normal"] = {
			{
				{ 1, "s137769", "94266", "=q4=Haunted Steel Greathelm", "=ds=#s1#, #a4# / =q1=#sk# 500", "=ds="..AL["Discovery"]..": "..GetSpellInfo(138646)};
				{ 2, "s137767", "94264", "=q4=Haunted Steel Headcover", "=ds=#s1#, #a4# / =q1=#sk# 500", "=ds="..AL["Discovery"]..": "..GetSpellInfo(138646)};
				{ 3, "s137771", "94268", "=q4=Haunted Steel Headguard", "=ds=#s1#, #a4# / =q1=#sk# 500", "=ds="..AL["Discovery"]..": "..GetSpellInfo(138646)};
				{ 4, "s137766", "94263", "=q4=Haunted Steel Greaves", "=ds=#s12#, #a4# / =q1=#sk# 500", "=ds="..AL["Discovery"]..": "..GetSpellInfo(138646)};
				{ 5, "s137768", "94265", "=q4=Haunted Steel Treads", "=ds=#s12#, #a4# / =q1=#sk# 500", "=ds="..AL["Discovery"]..": "..GetSpellInfo(138646)};
				{ 6, "s137770", "94267", "=q4=Haunted Steel Warboots", "=ds=#s12#, #a4# / =q1=#sk# 500", "=ds="..AL["Discovery"]..": "..GetSpellInfo(138646)};
				...
				{ 19, "s140844", "93455", "=q3=Crafted Dreadful Gladiator's Dreadplate Helm", "=ds=#s1#, #a4# / =q1=#sk# 500", "=ds="..AL["Discovery"]..": "..GetSpellInfo(138646)};
				{ 20, "s140842", "93457", "=q3=Crafted Dreadful Gladiator's Dreadplate Shoulders", "=ds=#s3#, #a4# / =q1=#sk# 500", "=ds="..AL["Discovery"]..": "..GetSpellInfo(138646)};
				{ 21, "s140846", "93453", "=q3=Crafted Dreadful Gladiator's Dreadplate Chestpiece", "=ds=#s5#, #a4# / =q1=#sk# 500", "=ds="..AL["Discovery"]..": "..GetSpellInfo(138646)};
				{ 22, "s140845", "93454", "=q3=Crafted Dreadful Gladiator's Dreadplate Gauntlets", "=ds=#s9#, #a4# / =q1=#sk# 500", "=ds="..AL["Discovery"]..": "..GetSpellInfo(138646)};
				{ 23, "s140843", "93456", "=q3=Crafted Dreadful Gladiator's Dreadplate Legguards", "=ds=#s11#, #a4# / =q1=#sk# 500", "=ds="..AL["Discovery"]..": "..GetSpellInfo(138646)};
				{ 24, "s137773", "93529", "=q3=Crafted Dreadful Gladiator's Scaled Helm", "=ds=#s1#, #a4# / =q1=#sk# 500", "=ds="..AL["Discovery"]..": "..GetSpellInfo(138646)};
				{ 25, "s137775", "93531", "=q3=Crafted Dreadful Gladiator's Scaled Shoulders", "=ds=#s3#, #a4# / =q1=#sk# 500", "=ds="..AL["Discovery"]..": "..GetSpellInfo(138646)};
				{ 26, "s140841", "93527", "=q3=Crafted Dreadful Gladiator's Scaled Chestpiece", "=ds=#s5#, #a4# / =q1=#sk# 500", "=ds="..AL["Discovery"]..": "..GetSpellInfo(138646)};
				{ 27, "s137772", "93528", "=q3=Crafted Dreadful Gladiator's Scaled Gauntlets", "=ds=#s9#, #a4# / =q1=#sk# 500", "=ds="..AL["Discovery"]..": "..GetSpellInfo(138646)};
				{ 28, "s137774", "93530", "=q3=Crafted Dreadful Gladiator's Scaled Legguards", "=ds=#s11#, #a4# / =q1=#sk# 500", "=ds="..AL["Discovery"]..": "..GetSpellInfo(138646)};
				{ 29, "s137784", "93540", "=q3=Crafted Dreadful Gladiator's Ornamented Headcover", "=ds=#s1#, #a4# / =q1=#sk# 500", "=ds="..AL["Discovery"]..": "..GetSpellInfo(138646)};
				{ 30, "s137786", "93542", "=q3=Crafted Dreadful Gladiator's Ornamented Spaulders", "=ds=#s3#, #a4# / =q1=#sk# 500", "=ds="..AL["Discovery"]..": "..GetSpellInfo(138646)};
			};
			{
				{ 1, "s137782", "93538", "=q3=Crafted Dreadful Gladiator's Ornamented Chestguard", "=ds=#s5#, #a4# / =q1=#sk# 500", "=ds="..AL["Discovery"]..": "..GetSpellInfo(138646)};
				{ 2, "s137783", "93539", "=q3=Crafted Dreadful Gladiator's Ornamented Gloves", "=ds=#s9#, #a4# / =q1=#sk# 500", "=ds="..AL["Discovery"]..": "..GetSpellInfo(138646)};
				{ 3, "s137785", "93541", "=q3=Crafted Dreadful Gladiator's Ornamented Legplates", "=ds=#s11#, #a4# / =q1=#sk# 500", "=ds="..AL["Discovery"]..": "..GetSpellInfo(138646)};
				{ 4, "s137795", "93622", "=q3=Crafted Dreadful Gladiator's Plate Helm", "=ds=#s1#, #a4# / =q1=#sk# 500", "=ds="..AL["Discovery"]..": "..GetSpellInfo(138646)};
				{ 5, "s137797", "93624", "=q3=Crafted Dreadful Gladiator's Plate Shoulders", "=ds=#s3#, #a4# / =q1=#sk# 500", "=ds="..AL["Discovery"]..": "..GetSpellInfo(138646)};
				{ 6, "s137793", "93620", "=q3=Crafted Dreadful Gladiator's Plate Chestpiece", "=ds=#s5#, #a4# / =q1=#sk# 500", "=ds="..AL["Discovery"]..": "..GetSpellInfo(138646)};
				{ 7, "s137794", "93621", "=q3=Crafted Dreadful Gladiator's Plate Gauntlets", "=ds=#s9#, #a4# / =q1=#sk# 500", "=ds="..AL["Discovery"]..": "..GetSpellInfo(138646)};
				{ 8, "s137796", "93623", "=q3=Crafted Dreadful Gladiator's Plate Legguards", "=ds=#s11#, #a4# / =q1=#sk# 500", "=ds="..AL["Discovery"]..": "..GetSpellInfo(138646)};
				{ 9, "s137792", "93548", "=q3=Crafted Dreadful Gladiator's Armplates of Alacrity", "=ds=#s8#, #a4# / =q1=#sk# 500", "=ds="..AL["Discovery"]..": "..GetSpellInfo(138646)};
				{ 10, "s137791", "93547", "=q3=Crafted Dreadful Gladiator's Armplates of Proficiency", "=ds=#s8#, #a4# / =q1=#sk# 500", "=ds="..AL["Discovery"]..": "..GetSpellInfo(138646)};
				{ 11, "s137781", "93537", "=q3=Crafted Dreadful Gladiator's Bracers of Meditation", "=ds=#s8#, #a4# / =q1=#sk# 500", "=ds="..AL["Discovery"]..": "..GetSpellInfo(138646)};
				{ 12, "s137780", "93536", "=q3=Crafted Dreadful Gladiator's Bracers of Prowess", "=ds=#s8#, #a4# / =q1=#sk# 500", "=ds="..AL["Discovery"]..": "..GetSpellInfo(138646)};
				{ 13, "s137776", "93532", "=q3=Crafted Dreadful Gladiator's Clasp of Cruelty", "=ds=#s10#, #a4# / =q1=#sk# 500", "=ds="..AL["Discovery"]..": "..GetSpellInfo(138646)};
				{ 14, "s137777", "93533", "=q3=Crafted Dreadful Gladiator's Clasp of Meditation", "=ds=#s10#, #a4# / =q1=#sk# 500", "=ds="..AL["Discovery"]..": "..GetSpellInfo(138646)};
				{ 15, "s137787", "93543", "=q3=Crafted Dreadful Gladiator's Girdle of Accuracy", "=ds=#s10#, #a4# / =q1=#sk# 500", "=ds="..AL["Discovery"]..": "..GetSpellInfo(138646)};
				{ 16, "s137788", "93544", "=q3=Crafted Dreadful Gladiator's Girdle of Prowess", "=ds=#s10#, #a4# / =q1=#sk# 500", "=ds="..AL["Discovery"]..": "..GetSpellInfo(138646)};
				{ 17, "s137778", "93534", "=q3=Crafted Dreadful Gladiator's Greaves of Alacrity", "=ds=#s12#, #a4# / =q1=#sk# 500", "=ds="..AL["Discovery"]..": "..GetSpellInfo(138646)};
				{ 18, "s137779", "93535", "=q3=Crafted Dreadful Gladiator's Greaves of Meditation", "=ds=#s12#, #a4# / =q1=#sk# 500", "=ds="..AL["Discovery"]..": "..GetSpellInfo(138646)};
				{ 19, "s137790", "93546", "=q3=Crafted Dreadful Gladiator's Warboots of Alacrity", "=ds=#s12#, #a4# / =q1=#sk# 500", "=ds="..AL["Discovery"]..": "..GetSpellInfo(138646)};
				{ 20, "s137789", "93545", "=q3=Crafted Dreadful Gladiator's Warboots of Cruelty", "=ds=#s12#, #a4# / =q1=#sk# 500", "=ds="..AL["Discovery"]..": "..GetSpellInfo(138646)};
	...
	AtlasLoot_Data["SmithingWeaponMoP"] = {
		["Normal"] = {
			{
				{ 1, "s138892", "94591", "=q4=Blazefury, Reborn", "=ds=#h1#, #w10# / =ds=#sr# 500", "=ds="..AL["Discovery"]..": "..GetSpellInfo(138890)};
				{ 2, "s138881", "94580", "=q4=Bloodmoon, Reborn", "=ds=#h2#, #w1# / =ds=#sr# 500", "=ds="..AL["Discovery"]..": "..GetSpellInfo(138879)};
				{ 3, "s138886", "94585", "=q4=Dragonstrike, Reborn", "=ds=#h1#, #w6# / =ds=#sr# 500", "=ds="..AL["Discovery"]..": "..GetSpellInfo(138885)};
				{ 4, "s138893", "94592", "=q4=Lionheart Executioner, Reborn", "=ds=#h2#, #w10# / =ds=#sr# 500", "=ds="..AL["Discovery"]..": "..GetSpellInfo(138891)};
				{ 5, "s138887", "94586", "=q4=Stormherald, Reborn", "=ds=#h2#, #w6# / =ds=#sr# 500", "=ds="..AL["Discovery"]..": "..GetSpellInfo(138884)};
				{ 6, "s138880", "94579", "=q4=Wicked Edge of the Planes, Reborn", "=ds=#h1#, #w1# / =ds=#sr# 500", "=ds="..AL["Discovery"]..": "..GetSpellInfo(138878)};
				{ 7, "s138878", "94577", "=q4=Black Planar Edge, Reborn", "=ds=#h1#, #w1# / =ds=#sr# 500", "=ds="..AL["Discovery"]..": "..GetSpellInfo(138876)};
				{ 8, "s138890", "94589", "=q4=Blazeguard, Reborn", "=ds=#h1#, #w10# / =ds=#sr# 500", "=ds="..AL["Discovery"]..": "..GetSpellInfo(138888)};
				{ 9, "s138884", "94583", "=q4=Deep Thunder, Reborn", "=ds=#h2#, #w6# / =ds=#sr# 500", "=ds="..AL["Discovery"]..": "..GetSpellInfo(138883)};
				{ 10, "s138885", "94584", "=q4=Dragonmaw, Reborn", "=ds=#h1#, #w6# / =ds=#sr# 500", "=ds="..AL["Discovery"]..": "..GetSpellInfo(138882)};
				{ 11, "s138891", "94590", "=q4=Lionheart Champion, Reborn", "=ds=#h2#, #w10# / =ds=#sr# 500", "=ds="..AL["Discovery"]..": "..GetSpellInfo(138889)};
				{ 12, "s138879", "94578", "=q4=Mooncleaver, Reborn", "=ds=#h2#, #w1# / =ds=#sr# 500", "=ds="..AL["Discovery"]..": "..GetSpellInfo(138877)};
				{ 13, "s138882", "94581", "=q3=Drakefist Hammer, Reborn", "=ds=#h1#, #w6# / =ds=#sr# 500", "=ds=#QUESTID:32621#"};
				{ 14, "s138888", "94587", "=q3=Fireguard, Reborn", "=ds=#h1#, #w10# / =ds=#sr# 500", "=ds=#QUESTID:32621#"};
				{ 15, "s138889", "94588", "=q3=Lionheart Blade, Reborn", "=ds=#h2#, #w10# / =ds=#sr# 500", "=ds=#QUESTID:32621#"};
				{ 16, "s138877", "94576", "=q3=Lunar Crescent, Reborn", "=ds=#h2#, #w1# / =ds=#sr# 500", "=ds=#QUESTID:32621#"};
				{ 17, "s138876", "94575", "=q3=The Planar Edge, Reborn", "=ds=#h1#, #w1# / =ds=#sr# 500", "=ds=#QUESTID:32621#"};
				{ 18, "s138883", "94582", "=q3=Thunder, Reborn", "=ds=#h2#, #w6# / =ds=#sr# 500", "=ds=#QUESTID:32621#"};
				{ 19, "s122644", "82970", "=q3=Masterwork Forgewire Axe", "=ds=#h1#, #w1# / =ds=#sr# 575", "=ds="..ALIL["The Klaxxi"].." - "..AL["Honored"]};
				{ 20, "s122648", "82974", "=q3=Masterwork Ghost Shard", "=ds=#h1#, #w4# / =ds=#sr# 575", "=ds="..ALIL["The Klaxxi"].." - "..AL["Honored"]};
				{ 21, "s122645", "82971", "=q3=Masterwork Ghost-Forged Blade", "=ds=#h1#, #w10# / =ds=#sr# 575", "=ds="..ALIL["The Klaxxi"].." - "..AL["Honored"]};
				{ 22, "s122646", "82972", "=q3=Masterwork Phantasmal Hammer", "=ds=#h1#, #w6# / =ds=#sr# 575", "=ds="..ALIL["The Klaxxi"].." - "..AL["Honored"]};
				{ 23, "s122647", "82973", "=q3=Masterwork Spiritblade Decimator", "=ds=#h2#, #w1# / =ds=#sr# 575", "=ds="..ALIL["The Klaxxi"].." - "..AL["Honored"]};
				{ 24, "s122642", "82968", "=q3=Masterwork Lightsteel Shield", "=ds=#w8# / =ds=#sr# 575", "=ds="..AL["Vendor"]};
				{ 25, "s122643", "82969", "=q3=Masterwork Spiritguard Shield", "=ds=#w8# / =ds=#sr# 575", "=ds="..AL["Vendor"]};
				{ 26, "s122641", "82967", "=q3=Ghost Shard", "=ds=#h1#, #w4# / =ds=#sr# 565", "=ds="..AL["Trainer"]};
				{ 27, "s122640", "82966", "=q3=Spiritblade Decimator", "=ds=#h2#, #w1# / =ds=#sr# 565", "=ds="..AL["Trainer"]};
				{ 28, "s122639", "82965", "=q3=Phantasmal Hammer", "=ds=#h1#, #w6# / =ds=#sr# 560", "=ds="..AL["Trainer"]};
				{ 29, "s122637", "82963", "=q3=Forgewire Axe", "=ds=#h1#, #w1# / =ds=#sr# 545", "=ds="..AL["Trainer"]};
				{ 30, "s122638", "82964", "=q3=Ghost-Forged Blade", "=ds=#h1#, #w10# / =ds=#sr# 545", "=ds="..AL["Trainer"]};
			};
			{
				{ 1, "s122636", "82962", "=q2=Spiritguard Shield", "=ds=#w8# / =ds=#sr# 545", "=ds="..AL["Trainer"]};
				{ 2, "s122635", "82961", "=q2=Lightsteel Shield", "=ds=#w8# / =ds=#sr# 540", "=ds="..AL["Trainer"]};
			};
		};
		info = {
		...
		["Normal"] = {
			{
				...
				{ 5, "s8768", "7071", "=q1=Iron Buckle", "=ds=#sr# 150", "=ds="..AL["Trainer"], amount = 2};
				{ 7, "s122633", "82960", "=q1=Ghostly Skeleton Key", "=ds=#sr# 500", "=ds="..AL["Trainer"]};
				{ 8, "s76438", "55053", "=q1=Obsidium Skeleton Key", "=ds=#sr# 475", "=ds="..AL["Trainer"], amount = 2};
				{ 9, "s59406", "43853", "=q2=Titanium Skeleton Key", "=ds=#sr# 430", "=ds="..AL["Trainer"], amount = 20};
				{ 10, "s59405", "43854", "=q2=Cobalt Skeleton Key", "=ds=#sr# 350", "=ds="..AL["Trainer"], amount = 10};
				{ 11, "s19669", "15872", "=q2=Arcanite Skeleton Key", "=ds=#sr# 275", "=ds="..AL["Trainer"], amount = 2};
				{ 12, "s19668", "15871", "=q2=Truesilver Skeleton Key", "=ds=#sr# 200", "=ds="..AL["Trainer"], amount = 2};
				{ 13, "s19667", "15870", "=q2=Golden Skeleton Key", "=ds=#sr# 150", "=ds="..AL["Trainer"], amount = 2};
				{ 14, "s19666", "15869", "=q2=Silver Skeleton Key", "=ds=#sr# 100", "=ds="..AL["Trainer"], amount = 2};
		...
		["Normal"] = {
			{
				...
				{ 3, "s104302", "74647", "=q1=Valley Stir Fry", "=ds=#sr# 550", "=ds="..ALIL["Way of the Wok"]};
				{ 4, "s104301", "74643", "=q1=Sauteed Carrots", "=ds=#sr# 525", "=ds="..ALIL["Way of the Wok"]};
				...
				{ 7, "s57441", "42999", "=q1=Blackened Dragonfin", "=ds=#sr# 400", "=ds="..AL["Vendor"]..": "..ALIL["Dalaran"]};
				{ 8, "s33288", "27659", "=q1=Warp Burger", "=ds=#sr# 325", "=ds="..AL["Vendor"]..": "..ALIL["Terokkar Forest"]};
				{ 9, "s33293", "27664", "=q1=Grilled Mudfish", "=ds=#sr# 320", "=ds="..AL["Vendor"]..": "..ALIL["Nagrand"]};
				{ 10, "s18240", "13928", "=q1=Grilled Squid", "=ds=#sr# 240", "=ds="..AL["Trainer"]};
				{ 12, 0, "INV_Box_01", "=q6="..AL["Spirit"]};
				{ 13, "s104309", "74653", "=q1=Steamed Crab Surprise", "=ds=#sr# 600", "=ds="..ALIL["Way of the Steamer"], amount = 5};
				{ 14, "s104308", "74652", "=q1=Fire Spirit Salmon", "=ds=#sr# 550", "=ds="..ALIL["Way of the Steamer"]};
				{ 15, "s104307", "74651", "=q1=Shrimp Dumplings", "=ds=#sr# 525", "=ds="..ALIL["Way of the Steamer"]};
				{ 16, 0, "INV_Box_01", "=q6="..AL["Intellect"]};
				{ 17, "s104306", "74650", "=q1=Mogu Fish Stew", "=ds=#sr# 600", "=ds="..ALIL["Way of the Pot"], amount = 5};
				{ 18, "s104305", "74649", "=q1=Braised Turtle", "=ds=#sr# 550", "=ds="..ALIL["Way of the Pot"]};
				{ 19, "s104304", "74644", "=q1=Swirling Mist Soup", "=ds=#sr# 525", "=ds="..ALIL["Way of the Pot"]};
				...
				{ 25, "s104312", "74656", "=q1=Chun Tian Spring Rolls", "=ds=#sr# 600", "=ds="..ALIL["Way of the Oven"], amount = 5};
				{ 26, "s104311", "74655", "=q1=Twin Fish Platter", "=ds=#sr# 550", "=ds="..ALIL["Way of the Oven"]};
				{ 27, "s104310", "74654", "=q1=Wildfowl Roast", "=ds=#sr# 525", "=ds="..ALIL["Way of the Oven"]};
			};
			{
				{ 1, 0, "INV_Box_01", "=q6="..AL["Strength"]};
				{ 2, "s104300", "74646", "=q1=Black Pepper Ribs and Shrimp", "=ds=#sr# 600", "=ds="..ALIL["Way of the Grill"], amount = 5};
				{ 3, "s104299", "74645", "=q1=Eternal Blossom Fish", "=ds=#sr# 550", "=ds="..ALIL["Way of the Grill"]};
				{ 4, "s104298", "74642", "=q1=Charbroiled Tiger Steak", "=ds=#sr# 525", "=ds="..ALIL["Way of the Grill"]};
				...
				{ 7, "s57442", "43000", "=q1=Dragonfin Filet", "=ds=#sr# 400", "=ds="..AL["Vendor"]..": "..ALIL["Dalaran"]};
				{ 8, "s33287", "27658", "=q1=Roasted Clefthoof", "=ds=#sr# 325", "=ds="..AL["Vendor"]..": "..ALIL["Nagrand"]};
	...
	AtlasLoot_Data["CookingBanquetFeast"] = {
		["Normal"] = {
			{
				{ 1, "s105190", "74919", "=q1=Pandaren Banquet", "=ds=#sr# 600", "=ds=#QUESTID:31521#", amount = 5};
				{ 2, "s105194", "75016", "=q1=Great Pandaren Banquet", "=ds=#sr# 600", "=ds=#QUESTID:31521#", amount = 5};
				{ 3, "s125602", "87246", "=q1=Banquet of the Brew", "=ds=#sr# 575", "=ds="..ALIL["Way of the Brew"], amount = 5};
				{ 4, "s125603", "87248", "=q1=Great Banquet of the Brew", "=ds=#sr# 575", "=ds="..ALIL["Way of the Brew"], amount = 5};
				{ 5, "s125141", "87226", "=q1=Banquet of the Grill", "=ds=#sr# 575", "=ds="..ALIL["Way of the Grill"], amount = 5};
				{ 6, "s125142", "87228", "=q1=Great Banquet of the Grill", "=ds=#sr# 575", "=ds="..ALIL["Way of the Grill"], amount = 5};
				{ 7, "s125600", "87242", "=q1=Banquet of the Oven", "=ds=#sr# 575", "=ds="..ALIL["Way of the Oven"], amount = 5};
				{ 8, "s125601", "87244", "=q1=Great Banquet of the Oven", "=ds=#sr# 575", "=ds="..ALIL["Way of the Oven"], amount = 5};
				{ 9, "s125596", "87234", "=q1=Banquet of the Pot", "=ds=#sr# 575", "=ds="..ALIL["Way of the Pot"], amount = 5};
				{ 10, "s125597", "87236", "=q1=Great Banquet of the Pot", "=ds=#sr# 575", "=ds="..ALIL["Way of the Pot"], amount = 5};
				{ 11, "s125598", "87238", "=q1=Banquet of the Steamer", "=ds=#sr# 575", "=ds="..ALIL["Way of the Steamer"], amount = 5};
				{ 12, "s125599", "87240", "=q1=Great Banquet of the Steamer", "=ds=#sr# 575", "=ds="..ALIL["Way of the Steamer"], amount = 5};
				{ 13, "s125594", "87230", "=q1=Banquet of the Wok", "=ds=#sr# 575", "=ds="..ALIL["Way of the Wok"], amount = 5};
				{ 14, "s125595", "87232", "=q1=Great Banquet of the Wok", "=ds=#sr# 575", "=ds="..ALIL["Way of the Wok"], amount = 5};
				...
				{ 18, "s57423", "43015", "=q1=Fish Feast", "=ds=#sr# 450", "=ds="..AL["Vendor"]..": "..ALIL["Dalaran"]};
				{ 19, "s58527", "43478", "=q1=Gigantic Feast", "=ds=#sr# 425", "=ds="..AL["Vendor"]..": "..ALIL["Dalaran"]};
				{ 20, "s58528", "43480", "=q1=Small Feast", "=ds=#sr# 425", "=ds="..AL["Vendor"]..": "..ALIL["Dalaran"]};
		...
		["Normal"] = {
			{
				...
				{ 4, "s84430", "68049", "=q1=Heat-Treated Spinning Lure", "=ds=#sr# 510", "=ds="..AL["Trainer"], amount = 2};
				...
				{ 14, "s56477", "42546", "=q1=Mana Injector Kit", "=ds=#sr# 415", "=ds="..AL["Trainer"], amount = 8};
				{ 15, "s55252", "40769", "=q1=Scrapbot Construction Kit", "=ds=#sr# 415", "=ds=#QUESTID:12889#", amount = 5};
				{ 16, "s67920", "48933", "=q3=Wormhole Generator: Northrend", "=ds=#sr# 415", "=ds="..AL["Trainer"]};
				{ 17, "s56476", "37567", "=q1=Healing Injector Kit", "=ds=#sr# 410", "=ds="..AL["Trainer"], amount = 8};
				...
				{ 22, "s44391", "34113", "=q1=Field Repair Bot 110G", "=ds=#sr# 360", "=ds="..AL["Drop"], amount = 5};
				...
				{ 25, "s30552", "33093", "=q1=Mana Potion Injector", "=ds=#sr# 345", "=ds="..AL["Drop"], amount = 20};
				{ 26, "s30551", "33092", "=q1=Healing Potion Injector", "=ds=#sr# 330", "=ds="..AL["Drop"], amount = 20};
				{ 27, "s30337", "23767", "=q2=Crashin' Thrashin' Robot", "=ds=#sr# 325", "=ds="..AL["Drop"]};
				{ 28, "s30348", "23774", "=q2=Fel Iron Toolbox", "=ds=#sr# 325", "=ds="..AL["Vendor"]};
				{ 29, "s30568", "23841", "=q1=Gnomish Flame Turret", "=ds=#sr# 325", "=ds="..AL["Trainer"], amount = 3};
				{ 30, "s30548", "23821", "=q1=Zapthrottle Mote Extractor", "=ds=#sr# 305", "=ds="..BabbleInventory["Quest"]};
			};
			{
				{ 1, "s22704", "18232", "=q1=Field Repair Bot 74A", "=ds=#sr# 300", "=ds="..ALIL["Blackrock Depths"]};
				{ 2, "s19814", "16023", "=q1=Masterwork Target Dummy", "=ds=#sr# 275", "=ds="..AL["Vendor"]};
				{ 3, "s28327", "22728", "=q1=Steam Tonk Controller", "=ds=#sr# 275", "=ds="..ALIL["Darkmoon Faire"]};
				{ 4, "s23096", "18645", "=q2=Gnomish Alarm-O-Bot", "=ds=#sr# 265", "=ds="..ALIL["Blackrock Depths"], amount = 2};
				{ 5, "s23078", "18587", "=q1=Goblin Jumper Cables XL", "=ds=#sr# 265", "=ds="..ALIL["Blackrock Depths"]};
				...
				{ 16, "s3959", "4388", "=q1=Discombobulator Ray", "=ds=#sr# 160", "=ds="..ALIL["Gnomeregan"]};
				{ 17, "s3957", "4386", "=q1=Ice Deflector", "=ds=#sr# 155", "=ds=???"}; --schematic removed with Cata
				{ 18, "s9271", "6533", "=q1=Aquadynamic Fish Attractor", "=ds=#sr# 150", "=ds="..AL["Trainer"], amount = 3};
				{ 19, "s6458", "5507", "=q1=Ornate Spyglass", "=ds=#sr# 135", "=ds="..AL["Trainer"]};
				{ 20, "s3944", "4376", "=q1=Flame Deflector", "=ds=#sr# 125", "=ds="..ALIL["Gnomeregan"]};
	...
	AtlasLoot_Data["EngineeringReagents"] = {
		["Normal"] = {
			{
				{ 1, "s131563", "90146", "=q1=Tinker's Kit", "=ds=#sr# 550", "=ds="..AL["Trainer"], amount = 2};
				{ 2, "s127113", "77467", "=q1=Ghost Iron Bolts", "=ds=#sr# 500", "=ds="..AL["Trainer"], amount = 2};
				{ 3, "s127114", "77468", "=q1=High-Explosive Gunpowder", "=ds=#sr# 500", "=ds="..AL["Trainer"], amount = 2};
				{ 4, "s94748", "67749", "=q1=Electrified Ether", "=ds=#sr# 445", "=ds="..AL["Trainer"], amount = "2-3"};
				{ 5, "s84403", "60224", "=q1=Handful of Obsidium Bolts", "=ds=#sr# 425", "=ds="..AL["Trainer"], amount = "2-4"};
				{ 6, "s56471", "39683", "=q1=Froststeel Tube", "=ds=#sr# 390", "=ds="..AL["Trainer"]};
				{ 7, "s56464", "39682", "=q1=Overcharged Capacitor", "=ds=#sr# 375", "=ds="..AL["Trainer"]};
				{ 8, "s56349", "39681", "=q1=Handful of Cobalt Bolts", "=ds=#sr# 350", "=ds="..AL["Trainer"], amount = "1-3"};
				{ 9, "s53281", "39690", "=q1=Volatile Blasting Trigger", "=ds=#sr# 350", "=ds="..AL["Trainer"], amount = 2};
				{ 10, "s30309", "23787", "=q1=Felsteel Stabilizer", "=ds=#sr# 340", "=ds="..AL["Trainer"]};
				{ 11, "s30307", "23785", "=q1=Hardened Adamantite Tube", "=ds=#sr# 340", "=ds="..AL["Trainer"]};
				{ 12, "s30308", "23786", "=q1=Khorium Power Core", "=ds=#sr# 340", "=ds="..AL["Trainer"]};
				{ 13, "s39971", "32423", "=q1=Icy Blasting Primers", "=ds=#sr# 335", "=ds="..AL["Trainer"], amount = 10};
				{ 14, "s30306", "23784", "=q1=Adamantite Frame", "=ds=#sr# 325", "=ds="..AL["Trainer"]};
				{ 15, "s30305", "23783", "=q1=Handful of Fel Iron Bolts", "=ds=#sr# 300", "=ds="..AL["Trainer"]};
				{ 16, "s30303", "23781", "=q1=Elemental Blasting Powder", "=ds=#sr# 300", "=ds="..AL["Trainer"], amount = 4};
				{ 17, "s30304", "23782", "=q1=Fel Iron Casing", "=ds=#sr# 300", "=ds="..AL["Trainer"]};
				{ 18, "s19815", "16006", "=q1=Delicate Arcanite Converter", "=ds=#sr# 285", "=ds="..AL["Vendor"]};
				{ 19, "s19795", "16000", "=q1=Thorium Tube", "=ds=#sr# 275", "=ds="..AL["Trainer"]};
				{ 20, "s39895", "7191", "=q1=Fused Wiring", "=ds=#sr# 275", "=ds="..AL["Vendor"], amount = 5};
				{ 21, "s19791", "15994", "=q1=Thorium Widget", "=ds=#sr# 260", "=ds="..AL["Trainer"]};
				{ 22, "s23071", "18631", "=q1=Truesilver Transformer", "=ds=#sr# 260", "=ds="..AL["Trainer"]};
				{ 23, "s19788", "15992", "=q1=Dense Blasting Powder", "=ds=#sr# 250", "=ds="..AL["Trainer"]};
				{ 24, "s12599", "10561", "=q1=Mithril Casing", "=ds=#sr# 215", "=ds="..AL["Trainer"]};
				{ 25, "s12591", "10560", "=q1=Unstable Trigger", "=ds=#sr# 200", "=ds="..AL["Trainer"]};
				{ 26, "s12589", "10559", "=q1=Mithril Tube", "=ds=#sr# 195", "=ds="..AL["Trainer"]};
				{ 27, "s12590", "10498", "=q1=Gyromatic Micro-Adjustor", "=ds=#sr# 175", "=ds="..AL["Trainer"]};
				{ 28, "s12585", "10505", "=q1=Solid Blasting Powder", "=ds=#sr# 175", "=ds="..AL["Trainer"]};
				{ 29, "s3961", "4389", "=q1=Gyrochronatom", "=ds=#sr# 170", "=ds="..AL["Trainer"]};
				{ 30, "s3958", "4387", "=q1=Iron Strut", "=ds=#sr# 160", "=ds="..AL["Trainer"]};

			};
			{
				{ 1, "s12584", "10558", "=q1=Gold Power Core", "=ds=#sr# 150", "=ds="..AL["Trainer"], amount = 3};
				{ 2, "s3953", "4382", "=q1=Bronze Framework", "=ds=#sr# 145", "=ds="..AL["Trainer"]};
				{ 3, "s3942", "4375", "=q1=Whirring Bronze Gizmo", "=ds=#sr# 125", "=ds="..AL["Trainer"]};
				{ 4, "s3945", "4377", "=q1=Heavy Blasting Powder", "=ds=#sr# 125", "=ds="..AL["Trainer"] };
				{ 5, "s3938", "4371", "=q1=Bronze Tube", "=ds=#sr# 105", "=ds="..AL["Trainer"] };
				{ 6, "s3973", "4404", "=q1=Silver Contact", "=ds=#sr# 90", "=ds="..AL["Trainer"] };
				{ 7, "s3929", "4364", "=q1=Coarse Blasting Powder", "=ds=#sr# 75", "=ds="..AL["Trainer"] };
				{ 8, "s3924", "4361", "=q1=Copper Tube", "=ds=#sr# 50", "=ds="..AL["Trainer"] };
				{ 9, "s3922", "4359", "=q1=Handful of Copper Bolts", "=ds=#sr# 30", "=ds="..AL["Trainer"] };
				{ 10, "s3918", "4357", "=q1=Rough Blasting Powder", "=ds=#sr# 1", "=ds="..AL["Trainer"] };
			};
		};
		info = {
		...
		["Normal"] = {
			{
				...
				{ 6, "s15633", "11826", "=q1=Lil' Smoky", "=ds=#sr# 205", "=ds="..ALIL["Gnomeregan"] };
				{ 7, "s15628", "11825", "=q1=Pet Bombling", "=ds=#sr# 205", "=ds="..ALIL["Gnomeregan"] };
				...
				{ 18, "s60866", "41508", "=q4=Mechano-Hog", "=ds=#sr# 450", "=ds="..ALIL["Horde Expedition"].." - "..AL["Exalted"] };
				{ 19, "s60867", "44413", "=q4=Mekgineer's Chopper", "=ds=#sr# 450", "=ds="..ALIL["Alliance Vanguard"].." - "..AL["Exalted"] };
		...
		["Normal"] = {
			{
				...
				{ 10, "s92027", "63388", "=q1=Dust of Disappearance", "=ds=#sr# 475", "=ds="..AL["Trainer"], amount = 3 };
				...
				{ 13, "s52739", "38682", "=q1=Enchanting Vellum", "=ds=#sr# 35", "=ds="..AL["Trainer"], amount = 2 };
		...
		["Normal"] = {
			{
				...
				{ 4, "s101057", "71155", "=q1=Glyph of Lightning Shield", "=ds=#sr# 430", "=ds="..GetSpellInfo(61177) };
				{ 5, "s64289", "45772", "=q1=Glyph of Riptide", "=ds=#sr# 430", "=ds="..GetSpellInfo(61177) };
				{ 6, "s64287", "45770", "=q1=Glyph of Thunder", "=ds=#sr# 430", "=ds="..GetSpellInfo(61177) };
				{ 7, "s64247", "45778", "=q1=Glyph of Totemic Vigor", "=ds=#sr# 430", "=ds="..GetSpellInfo(61177) };
	...
	AtlasLoot_Data["LeatherLeatherArmorMoP"] = {
		["Normal"] = {
			{
				{ 1, "s138590", "94270", "=q4=Quilen Hide Helm", "=ds=#s1#, #a2# / =q1=#sk# 500", "=ds="..AL["Discovery"]..": "..GetSpellInfo(140040)};
				{ 2, "s138594", "94274", "=q4=Spirit Keeper Helm", "=ds=#s1#, #a2# / =q1=#sk# 500", "=ds="..AL["Discovery"]..": "..GetSpellInfo(140040)};
				{ 3, "s138589", "94269", "=q4=Quilen Hide Boots", "=ds=#s12#, #a2# / =q1=#sk# 500", "=ds="..AL["Discovery"]..": "..GetSpellInfo(140040)};
				{ 4, "s138593", "94273", "=q4=Spirit Keeper Footguards", "=ds=#s12#, #a2# / =q1=#sk# 500", "=ds="..AL["Discovery"]..": "..GetSpellInfo(140040)};
				...
				{ 13, "s137826", "93476", "=q3=Crafted Dreadful Gladiator's Wyrmhide Helm", "=ds=#s1#, #a2# / =q1=#sk# 500", "=ds="..AL["Discovery"]..": "..GetSpellInfo(140040)};
				{ 14, "s137829", "93479", "=q3=Crafted Dreadful Gladiator's Wyrmhide Spaulders", "=ds=#s3#, #a2# / =q1=#sk# 500", "=ds="..AL["Discovery"]..": "..GetSpellInfo(140040)};
				{ 15, "s137828", "93478", "=q3=Crafted Dreadful Gladiator's Wyrmhide Robes", "=ds=#s5#, #a2# / =q1=#sk# 500", "=ds="..AL["Discovery"]..": "..GetSpellInfo(140040)};
				{ 16, "s137825", "93475", "=q3=Crafted Dreadful Gladiator's Wyrmhide Gloves", "=ds=#s9#, #a2# / =q1=#sk# 500", "=ds="..AL["Discovery"]..": "..GetSpellInfo(140040)};
				{ 17, "s137827", "93477", "=q3=Crafted Dreadful Gladiator's Wyrmhide Legguards", "=ds=#s11#, #a2# / =q1=#sk# 500", "=ds="..AL["Discovery"]..": "..GetSpellInfo(140040)};
				{ 18, "s137810", "93459", "=q3=Crafted Dreadful Gladiator's Dragonhide Helm", "=ds=#s1#, #a2# / =q1=#sk# 500", "=ds="..AL["Discovery"]..": "..GetSpellInfo(140040)};
				{ 19, "s137813", "93462", "=q3=Crafted Dreadful Gladiator's Dragonhide Spaulders", "=ds=#s3#, #a2# / =q1=#sk# 500", "=ds="..AL["Discovery"]..": "..GetSpellInfo(140040)};
				{ 20, "s137812", "93461", "=q3=Crafted Dreadful Gladiator's Dragonhide Robes", "=ds=#s5#, #a2# / =q1=#sk# 500", "=ds="..AL["Discovery"]..": "..GetSpellInfo(140040)};
				{ 21, "s137809", "93458", "=q3=Crafted Dreadful Gladiator's Dragonhide Gloves", "=ds=#s9#, #a2# / =q1=#sk# 500", "=ds="..AL["Discovery"]..": "..GetSpellInfo(140040)};
				{ 22, "s137811", "93460", "=q3=Crafted Dreadful Gladiator's Dragonhide Legguards", "=ds=#s11#, #a2# / =q1=#sk# 500", "=ds="..AL["Discovery"]..": "..GetSpellInfo(140040)};
				{ 23, "s137818", "93467", "=q3=Crafted Dreadful Gladiator's Kodohide Helm", "=ds=#s1#, #a2# / =q1=#sk# 500", "=ds="..AL["Discovery"]..": "..GetSpellInfo(140040)};
				{ 24, "s137821", "93470", "=q3=Crafted Dreadful Gladiator's Kodohide Spaulders", "=ds=#s3#, #a2# / =q1=#sk# 500", "=ds="..AL["Discovery"]..": "..GetSpellInfo(140040)};
				{ 25, "s137820", "93469", "=q3=Crafted Dreadful Gladiator's Kodohide Robes", "=ds=#s5#, #a2# / =q1=#sk# 500", "=ds="..AL["Discovery"]..": "..GetSpellInfo(140040)};
				{ 26, "s137817", "93466", "=q3=Crafted Dreadful Gladiator's Kodohide Gloves", "=ds=#s9#, #a2# / =q1=#sk# 500", "=ds="..AL["Discovery"]..": "..GetSpellInfo(140040)};
				{ 27, "s137819", "93468", "=q3=Crafted Dreadful Gladiator's Kodohide Legguards", "=ds=#s11#, #a2# / =q1=#sk# 500", "=ds="..AL["Discovery"]..": "..GetSpellInfo(140040)};
				{ 28, "s137839", "93519", "=q3=Crafted Dreadful Gladiator's Copperskin Helm", "=ds=#s1#, #a2# / =q1=#sk# 500", "=ds="..AL["Discovery"]..": "..GetSpellInfo(140040)};
				{ 29, "s137841", "93523", "=q3=Crafted Dreadful Gladiator's Copperskin Spaulders", "=ds=#s3#, #a2# / =q1=#sk# 500", "=ds="..AL["Discovery"]..": "..GetSpellInfo(140040)};
				{ 30, "s137842", "93525", "=q3=Crafted Dreadful Gladiator's Copperskin Tunic", "=ds=#s5#, #a2# / =q1=#sk# 500", "=ds="..AL["Discovery"]..": "..GetSpellInfo(140040)};
			};
			{
				{ 1, "s137838", "93517", "=q3=Crafted Dreadful Gladiator's Copperskin Gloves", "=ds=#s9#, #a2# / =q1=#sk# 500", "=ds="..AL["Discovery"]..": "..GetSpellInfo(140040)};
				{ 2, "s137840", "93521", "=q3=Crafted Dreadful Gladiator's Copperskin Legguards", "=ds=#s11#, #a2# / =q1=#sk# 500", "=ds="..AL["Discovery"]..": "..GetSpellInfo(140040)};
				{ 3, "s137834", "93509", "=q3=Crafted Dreadful Gladiator's Ironskin Helm", "=ds=#s1#, #a2# / =q1=#sk# 500", "=ds="..AL["Discovery"]..": "..GetSpellInfo(140040)};
				{ 4, "s137836", "93513", "=q3=Crafted Dreadful Gladiator's Ironskin Spaulders", "=ds=#s3#, #a2# / =q1=#sk# 500", "=ds="..AL["Discovery"]..": "..GetSpellInfo(140040)};
				{ 5, "s137837", "93515", "=q3=Crafted Dreadful Gladiator's Ironskin Tunic", "=ds=#s5#, #a2# / =q1=#sk# 500", "=ds="..AL["Discovery"]..": "..GetSpellInfo(140040)};
				{ 6, "s137833", "93507", "=q3=Crafted Dreadful Gladiator's Ironskin Gloves", "=ds=#s9#, #a2# / =q1=#sk# 500", "=ds="..AL["Discovery"]..": "..GetSpellInfo(140040)};
				{ 7, "s137835", "93511", "=q3=Crafted Dreadful Gladiator's Ironskin Legguards", "=ds=#s11#, #a2# / =q1=#sk# 500", "=ds="..AL["Discovery"]..": "..GetSpellInfo(140040)};
				{ 8, "s137848", "93571", "=q3=Crafted Dreadful Gladiator's Leather Helm", "=ds=#s1#, #a2# / =q1=#sk# 500", "=ds="..AL["Discovery"]..": "..GetSpellInfo(140040)};
				{ 9, "s137850", "93573", "=q3=Crafted Dreadful Gladiator's Leather Spaulders", "=ds=#s3#, #a2# / =q1=#sk# 500", "=ds="..AL["Discovery"]..": "..GetSpellInfo(140040)};
				{ 10, "s137846", "93569", "=q3=Crafted Dreadful Gladiator's Leather Tunic", "=ds=#s5#, #a2# / =q1=#sk# 500", "=ds="..AL["Discovery"]..": "..GetSpellInfo(140040)};
				{ 11, "s137847", "93570", "=q3=Crafted Dreadful Gladiator's Leather Gloves", "=ds=#s9#, #a2# / =q1=#sk# 500", "=ds="..AL["Discovery"]..": "..GetSpellInfo(140040)};
				{ 12, "s137849", "93572", "=q3=Crafted Dreadful Gladiator's Leather Legguards", "=ds=#s11#, #a2# / =q1=#sk# 500", "=ds="..AL["Discovery"]..": "..GetSpellInfo(140040)};
				{ 13, "s137832", "93506", "=q3=Crafted Dreadful Gladiator's Armwraps of Accuracy", "=ds=#s8#, #a2# / =q1=#sk# 500", "=ds="..AL["Discovery"]..": "..GetSpellInfo(140040)};
				{ 14, "s137845", "93568", "=q3=Crafted Dreadful Gladiator's Armwraps of Alacrity", "=ds=#s8#, #a2# / =q1=#sk# 500", "=ds="..AL["Discovery"]..": "..GetSpellInfo(140040)};
				{ 15, "s137816", "93506", "=q3=Crafted Dreadful Gladiator's Bindings of Meditation", "=ds=#s8#, #a2# / =q1=#sk# 500", "=ds="..AL["Discovery"]..": "..GetSpellInfo(140040)};
				{ 16, "s137824", "93474", "=q3=Crafted Dreadful Gladiator's Bindings of Prowess", "=ds=#s8#, #a2# / =q1=#sk# 500", "=ds="..AL["Discovery"]..": "..GetSpellInfo(140040)};
				{ 17, "s137822", "93472", "=q3=Crafted Dreadful Gladiator's Belt of Cruelty", "=ds=#s10#, #a2# / =q1=#sk# 500", "=ds="..AL["Discovery"]..": "..GetSpellInfo(140040)};
				{ 18, "s137814", "93463", "=q3=Crafted Dreadful Gladiator's Belt of Meditation", "=ds=#s10#, #a2# / =q1=#sk# 500", "=ds="..AL["Discovery"]..": "..GetSpellInfo(140040)};
				{ 19, "s137843", "93566", "=q3=Crafted Dreadful Gladiator's Waistband of Accuracy", "=ds=#s10#, #a2# / =q1=#sk# 500", "=ds="..AL["Discovery"]..": "..GetSpellInfo(140040)};
				{ 20, "s137830", "93504", "=q3=Crafted Dreadful Gladiator's Waistband of Cruelty", "=ds=#s10#, #a2# / =q1=#sk# 500", "=ds="..AL["Discovery"]..": "..GetSpellInfo(140040)};
				{ 21, "s137831", "93505", "=q3=Crafted Dreadful Gladiator's Boots of Alacrity", "=ds=#s12#, #a2# / =q1=#sk# 500", "=ds="..AL["Discovery"]..": "..GetSpellInfo(140040)};
				{ 22, "s137844", "93567", "=q3=Crafted Dreadful Gladiator's Boots of Cruelty", "=ds=#s12#, #a2# / =q1=#sk# 500", "=ds="..AL["Discovery"]..": "..GetSpellInfo(140040)};
				{ 23, "s137823", "93473", "=q3=Crafted Dreadful Gladiator's Leather Footguards of Alacrity", "=ds=#s12#, #a2# / =q1=#sk# 500", "=ds="..AL["Discovery"]..": "..GetSpellInfo(140040)};
				{ 24, "s137815", "93464", "=q3=Crafted Dreadful Gladiator's Leather Footguards of Meditation", "=ds=#s12#, #a2# / =q1=#sk# 500", "=ds="..AL["Discovery"]..": "..GetSpellInfo(140040)};
	...
	AtlasLoot_Data["LeatherMailArmorMoP"] = {
		["Normal"] = {
			{
				{ 1, "s138596", "94276", "=q4=Cloud Serpent Helm", "=ds=#s1#, #a3# / =q1=#sk# 500", "=ds="..AL["Discovery"]..": "..GetSpellInfo(140041)};
				{ 2, "s138592", "94272", "=q4=Dreadrunner Helm", "=ds=#s1#, #a3# / =q1=#sk# 500", "=ds="..AL["Discovery"]..": "..GetSpellInfo(140041)};
				{ 3, "s138595", "94275", "=q4=Cloud Serpent Sabatons", "=ds=#s12#, #a3# / =q1=#sk# 500", "=ds="..AL["Discovery"]..": "..GetSpellInfo(140041)};
				{ 4, "s138591", "94271", "=q4=Dreadrunner Sabatons", "=ds=#s12#, #a3# / =q1=#sk# 500", "=ds="..AL["Discovery"]..": "..GetSpellInfo(140041)};
	...
	AtlasLoot_Data["LeatherDrumsBagsMisc"] = {
		["Normal"] = {
			{
				{ 1, "s140185", "95536", "=q3=Magnificent Hide Pack", "=ds=#sr# 595", "=ds="..AL["Discovery"]..": "..GetSpellInfo(140040)};
				{ 2, "s100583", "70136", "=q3=Royal Scribe's Satchel", "=ds=#sr# 510", "=ds="..ALIL["Molten Front"]};
				{ 3, "s100586", "70137", "=q3=Triple-Reinforced Mining Bag", "=ds=#sr# 500", "=ds="..ALIL["Molten Front"]};
				...
				{ 6, "s50971", "38347", "=q3=Mammoth Mining Bag", "=ds=#sr# 415", "=ds="..ALIL["The Sons of Hodir"].." - "..AL["Honored"] };
				{ 7, "s60643", "44446", "=q3=Pack of Endless Pockets", "=ds=#sr# 415", "=ds="..AL["Trainer"] };
				{ 8, "s50970", "38399", "=q3=Trapper's Traveling Pack", "=ds=#sr# 415", "=ds="..ALIL["The Kalu'ak"].." - "..AL["Revered"] };
				{ 9, "s35538", "29532", "=q2=Drums of Panic", "=ds=#sr# 370", "=ds="..ALIL["Keepers of Time"].." - "..AL["Honored"] };
				{ 10, "s35543", "29529", "=q3=Drums of Battle", "=ds=#sr# 365", "=ds="..ALIL["The Sha'tar"].." - "..AL["Honored"] };
				{ 11, "s44359", "34105", "=q3=Quiver of a Thousand Feathers", "=ds=#sr# 360" };
				{ 12, "s45117", "34490", "=q3=Bag of Many Hides", "=ds=#sr# 350", "=ds="..AL["Drop"]..": "..ALIL["Terokkar Forest"] };
				{ 16, "s32461", "25653", "=q3=Riding Crop", "=ds=#sr# 350", "=ds="..AL["Vendor"]..": "..ALIL["Old Hillsbrad Foothills"] };
				{
					{ 17, "s35539", "29531", "=q2=Drums of Restoration", "=ds=#sr# 350", "=ds="..ALIL["The Mag'har"].." - "..AL["Honored"] };
					{ 17, "s35539", "29531", "=q2=Drums of Restoration", "=ds=#sr# 350", "=ds="..ALIL["Kurenai"].." - "..AL["Honored"] };
				};
				{
					{ 18, "s35544", "29530", "=q2=Drums of Speed", "=ds=#sr# 345", "=ds="..ALIL["The Mag'har"].." - "..AL["Honored"] };
					{ 18, "s35544", "29530", "=q2=Drums of Speed", "=ds=#sr# 345", "=ds="..ALIL["Kurenai"].." - "..AL["Honored"] };
				};
				{ 19, "s35540", "29528", "=q2=Drums of War", "=ds=#sr# 340", "=ds="..AL["Trainer"] };
				{
					{ 20, "s35530", "29540", "=q2=Reinforced Mining Bag", "=ds=#sr# 325", "=ds="..ALIL["The Mag'har"].." - "..AL["Honored"] };
					{ 20, "s35530", "29540", "=q2=Reinforced Mining Bag", "=ds=#sr# 325", "=ds="..ALIL["Kurenai"].." - "..AL["Honored"] };
				};
				{ 21, "s45100", "34482", "=q2=Leatherworker's Satchel", "=ds=#sr# 300", "=ds="..AL["Trainer"] };
				{
					{ 22, "s32482", "25679", "=q1=Comfortable Insoles", "=ds=#sr# 300", "=ds="..AL["Vendor"].." - "..ALIL["Silvermoon City"] };
					{ 22, "s32482", "25679", "=q1=Comfortable Insoles", "=ds=#sr# 300", "=ds="..AL["Vendor"].." - "..ALIL["The Exodar"] };
				};
				{
					{ 23, "s44953", "34086", "=q1=Winter Boots", "=ds=#sr# 285", "=ds="..AL["Feast of Winter Veil"].." "..AL["Vendor"]..": "..ALIL["Orgrimmar"] };
					{ 23, "s44953", "34086", "=q1=Winter Boots", "=ds=#sr# 285", "=ds="..AL["Feast of Winter Veil"].." "..AL["Vendor"]..": "..ALIL["Ironforge"] };
				};
				{ 24, "s22815", "18258", "=q2=Gordok Ogre Suit", "=ds=#sr# 275", "=ds="..AL["Old Quest Reward"] };
				{
					{ 25, "s23190", "18662", "=q1=Heavy Leather Ball", "=ds=#sr# 150", "=ds="..AL["Vendor"]..": "..ALIL["Orgrimmar"] };
					{ 25, "s23190", "18662", "=q1=Heavy Leather Ball", "=ds=#sr# 150", "=ds="..AL["Vendor"]..": "..ALIL["Ironforge"] };
				};
				{
	...
	AtlasLoot_Data["TailoringArmorMoP"] = {
		["Normal"] = {
			{
				{ 1, "s138598", "94278", "=q4=Falling Blossom Cowl", "=ds=#s1#, #a1# / =q1=#sk# 550", "=ds="..AL["Discovery"]..": "..GetSpellInfo(125557)};
				{ 2, "s138600", "94280", "=q4=Falling Blossom Hood", "=ds=#s1#, #a1# / =q1=#sk# 550", "=ds="..AL["Discovery"]..": "..GetSpellInfo(125557)};
				{ 3, "s138599", "94279", "=q4=Falling Blossom Sandals", "=ds=#s12#, #a1# / =q1=#sk# 550", "=ds="..AL["Discovery"]..": "..GetSpellInfo(125557)};
				{ 4, "s138597", "94277", "=q4=Falling Blossom Treads", "=ds=#s12#, #a1# / =q1=#sk# 550", "=ds="..AL["Discovery"]..": "..GetSpellInfo(125557)};
				...
				{ 13, "s137922", "93500", "=q3=Crafted Dreadful Gladiator's Silk Cowl", "=ds=#s1#, #a1# / =q1=#sk# 550", "=ds="..AL["Discovery"]..": "..GetSpellInfo(125557)};
				{ 14, "s137925", "93503", "=q3=Crafted Dreadful Gladiator's Silk Amice", "=ds=#s3#, #a1# / =q1=#sk# 550", "=ds="..AL["Discovery"]..": "..GetSpellInfo(125557)};
				{ 15, "s137924", "93502", "=q3=Crafted Dreadful Gladiator's Silk Robe", "=ds=#s5#, #a1# / =q1=#sk# 550", "=ds="..AL["Discovery"]..": "..GetSpellInfo(125557)};
				{ 16, "s137921", "93499", "=q3=Crafted Dreadful Gladiator's Silk Handguards", "=ds=#s9#, #a1# / =q1=#sk# 550", "=ds="..AL["Discovery"]..": "..GetSpellInfo(125557)};
				{ 17, "s137923", "93501", "=q3=Crafted Dreadful Gladiator's Silk Trousers", "=ds=#s11#, #a1# / =q1=#sk# 550", "=ds="..AL["Discovery"]..": "..GetSpellInfo(125557)};
				{ 18, "s137932", "93556", "=q3=Crafted Dreadful Gladiator's Satin Hood", "=ds=#s1#, #a1# / =q1=#sk# 550", "=ds="..AL["Discovery"]..": "..GetSpellInfo(125557)};
				{ 19, "s137935", "93559", "=q3=Crafted Dreadful Gladiator's Satin Mantle", "=ds=#s3#, #a1# / =q1=#sk# 550", "=ds="..AL["Discovery"]..": "..GetSpellInfo(125557)};
				{ 20, "s137934", "93558", "=q3=Crafted Dreadful Gladiator's Satin Robe", "=ds=#s5#, #a1# / =q1=#sk# 550", "=ds="..AL["Discovery"]..": "..GetSpellInfo(125557)};
				{ 21, "s137931", "93555", "=q3=Crafted Dreadful Gladiator's Satin Gloves", "=ds=#s9#, #a1# / =q1=#sk# 550", "=ds="..AL["Discovery"]..": "..GetSpellInfo(125557)};
				{ 22, "s137933", "93557", "=q3=Crafted Dreadful Gladiator's Satin Leggings", "=ds=#s11#, #a1# / =q1=#sk# 550", "=ds="..AL["Discovery"]..": "..GetSpellInfo(125557)};
				{ 23, "s137927", "93551", "=q3=Crafted Dreadful Gladiator's Mooncloth Helm", "=ds=#s1#, #a1# / =q1=#sk# 550", "=ds="..AL["Discovery"]..": "..GetSpellInfo(125557)};
				{ 24, "s137930", "93554", "=q3=Crafted Dreadful Gladiator's Mooncloth Mantle", "=ds=#s3#, #a1# / =q1=#sk# 550", "=ds="..AL["Discovery"]..": "..GetSpellInfo(125557)};
				{ 25, "s137929", "93553", "=q3=Crafted Dreadful Gladiator's Mooncloth Robe", "=ds=#s5#, #a1# / =q1=#sk# 550", "=ds="..AL["Discovery"]..": "..GetSpellInfo(125557)};
				{ 26, "s137926", "93555", "=q3=Crafted Dreadful Gladiator's Mooncloth Gloves", "=ds=#s9#, #a1# / =q1=#sk# 550", "=ds="..AL["Discovery"]..": "..GetSpellInfo(125557)};
				{ 27, "s137928", "93552", "=q3=Crafted Dreadful Gladiator's Mooncloth Leggings", "=ds=#s11#, #a1# / =q1=#sk# 550", "=ds="..AL["Discovery"]..": "..GetSpellInfo(125557)};
				{ 28, "s137939", "93616", "=q3=Crafted Dreadful Gladiator's Felweave Cowl", "=ds=#s1#, #a1# / =q1=#sk# 550", "=ds="..AL["Discovery"]..": "..GetSpellInfo(125557)};
				{ 29, "s137942", "93619", "=q3=Crafted Dreadful Gladiator's Felweave Amice", "=ds=#s3#, #a1# / =q1=#sk# 550", "=ds="..AL["Discovery"]..": "..GetSpellInfo(125557)};
				{ 30, "s137941", "93618", "=q3=Crafted Dreadful Gladiator's Felweave Raiment", "=ds=#s5#, #a1# / =q1=#sk# 550", "=ds="..AL["Discovery"]..": "..GetSpellInfo(125557)};
			};
			{
				{ 1, "s137938", "93615", "=q3=Crafted Dreadful Gladiator's Felweave Handguards", "=ds=#s9#, #a1# / =q1=#sk# 550", "=ds="..AL["Discovery"]..": "..GetSpellInfo(125557)};
				{ 2, "s137940", "93617", "=q3=Crafted Dreadful Gladiator's Felweave Trousers", "=ds=#s11#, #a1# / =q1=#sk# 550", "=ds="..AL["Discovery"]..": "..GetSpellInfo(125557)};
				{ 3, "s137907", "93420", "=q3=Crafted Dreadful Gladiator's Cape of Cruelty", "=ds=#s4# / =q1=#sk# 550", "=ds="..AL["Discovery"]..": "..GetSpellInfo(125557)};
				{ 4, "s137908", "93421", "=q3=Crafted Dreadful Gladiator's Cape of Prowess", "=ds=#s4# / =q1=#sk# 550", "=ds="..AL["Discovery"]..": "..GetSpellInfo(125557)};
				{ 5, "s137936", "93607", "=q3=Crafted Dreadful Gladiator's Cloak of Alacrity", "=ds=#s4# / =q1=#sk# 550", "=ds="..AL["Discovery"]..": "..GetSpellInfo(125557)};
				{ 6, "s137937", "93608", "=q3=Crafted Dreadful Gladiator's Cloak of Prowess", "=ds=#s4# / =q1=#sk# 550", "=ds="..AL["Discovery"]..": "..GetSpellInfo(125557)};
				{ 7, "s137918", "93437", "=q3=Crafted Dreadful Gladiator's Drape of Cruelty", "=ds=#s4# / =q1=#sk# 550", "=ds="..AL["Discovery"]..": "..GetSpellInfo(125557)};
				{ 8, "s137920", "93439", "=q3=Crafted Dreadful Gladiator's Drape of Meditation", "=ds=#s4# / =q1=#sk# 550", "=ds="..AL["Discovery"]..": "..GetSpellInfo(125557)};
				{ 9, "s137919", "93438", "=q3=Crafted Dreadful Gladiator's Drape of Prowess", "=ds=#s4# / =q1=#sk# 550", "=ds="..AL["Discovery"]..": "..GetSpellInfo(125557)};
				{ 10, "s137915", "93434", "=q3=Crafted Dreadful Gladiator's Cuffs of Accuracy", "=ds=#s8#, #a1# / =q1=#sk# 550", "=ds="..AL["Discovery"]..": "..GetSpellInfo(125557)};
				{ 11, "s137917", "93436", "=q3=Crafted Dreadful Gladiator's Cuffs of Meditation", "=ds=#s8#, #a1# / =q1=#sk# 550", "=ds="..AL["Discovery"]..": "..GetSpellInfo(125557)};
				{ 12, "s137916", "93435", "=q3=Crafted Dreadful Gladiator's Cuffs of Prowess", "=ds=#s8#, #a1# / =q1=#sk# 550", "=ds="..AL["Discovery"]..": "..GetSpellInfo(125557)};
				{ 13, "s137910", "93429", "=q3=Crafted Dreadful Gladiator's Cord of Accuracy", "=ds=#s10#, #a1# / =q1=#sk# 550", "=ds="..AL["Discovery"]..": "..GetSpellInfo(125557)};
				{ 14, "s137909", "93428", "=q3=Crafted Dreadful Gladiator's Cord of Cruelty", "=ds=#s10#, #a1# / =q1=#sk# 550", "=ds="..AL["Discovery"]..": "..GetSpellInfo(125557)};
				{ 15, "s137911", "93430", "=q3=Crafted Dreadful Gladiator's Cord of Meditation", "=ds=#s10#, #a1# / =q1=#sk# 550", "=ds="..AL["Discovery"]..": "..GetSpellInfo(125557)};
				{ 16, "s137913", "93432", "=q3=Crafted Dreadful Gladiator's Treads of Alacrity", "=ds=#s12#, #a1# / =q1=#sk# 550", "=ds="..AL["Discovery"]..": "..GetSpellInfo(125557)};
				{ 17, "s137912", "93431", "=q3=Crafted Dreadful Gladiator's Treads of Cruelty", "=ds=#s12#, #a1# / =q1=#sk# 550", "=ds="..AL["Discovery"]..": "..GetSpellInfo(125557)};
				{ 18, "s137914", "93433", "=q3=Crafted Dreadful Gladiator's Treads of Meditation", "=ds=#s12#, #a1# / =q1=#sk# 550", "=ds="..AL["Discovery"]..": "..GetSpellInfo(125557)};
		...
		["Normal"] = {
			{
				...
				{ 15, "s18560", "14342", "=q1=Mooncloth", "=ds=#sr# 250", "=ds="..AL["Vendor"]..": "..ALIL["Winterspring"]};
