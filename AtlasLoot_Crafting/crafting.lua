-- $Id: crafting.lua 4172 2013-03-31 22:53:10Z dynaletik $
	...
	AtlasLoot_Data["AlchemyPotion"] = {
		["Normal"] = {
			...
			};
			{
				...
				{ 19, "s28575", "22845", "=q1=Major Arcane Protection Potion", "=ds=#sr# 360", "=ds="..ALIL["Nagrand"]};
				{ 20, "s28571", "22841", "=q1=Major Fire Protection Potion", "=ds=#sr# 360", "=ds="..ALIL["The Mechanar"]};
				{ 21, "s28572", "22842", "=q1=Major Frost Protection Potion", "=ds=#sr# 360", "=ds="..AtlasLoot:EJ_GetBossName("Nexus-Prince Shaffar", 537)..": "..ALIL["Mana-Tombs"]};
				{ 22, "s28577", "22847", "=q1=Major Holy Protection Potion", "=ds=#sr# 360", "=ds="..ALIL["Blade's Edge Mountains"]};
				{ 23, "s28573", "22844", "=q1=Major Nature Protection Potion", "=ds=#sr# 360", "=ds="..ALIL["Cenarion Expedition"].." - "..AL["Exalted"]};
				{ 24, "s28576", "22846", "=q1=Major Shadow Protection Potion", "=ds=#sr# 360", "=ds="..ALIL["Shadowmoon Valley"]};
		...
		["Normal"] = {
			{
				...
				{ 28, "s17636", "13511", "=q1=Flask of Distilled Wisdom", "=ds=#sr# 300", "=ds="..ALIL["Cenarion Expedition"].." - "..AL["Exalted"]};
				{ 29, "s17637", "13512", "=q1=Flask of Supreme Power", "=ds=#sr# 300", "=ds="..ALIL["Keepers of Time"].." - "..AL["Exalted"]};
				{ 30, "s17635", "13510", "=q1=Flask of the Titans", "=ds=#sr# 300", "=ds="..ALIL["The Sha'tar"].." - "..AL["Exalted"]};
			};
		};
		info = {
	...
	AtlasLoot_Data["AlchemyTransmute"] = {
		["Normal"] = {
			...
			};
			{
				...
				{ 20, "s25146", "7068", "=q1=Transmute: Elemental Fire", "=ds=#sr# 300", "=ds="..AL["Vendor"]..": "..ALIL["Blackrock Depths"]};
		...
		["Normal"] = {
			{
				...
				{ 2, "s104303", "74648", "=q1=Sea Mist Rice Noodles", "=ds=#sr# 600", "=ds="..ALIL["Way of the Wok"]};
				...
				{ 13, "s104309", "74653", "=q1=Steamed Crab Surprise", "=ds=#sr# 600", "=ds="..ALIL["Way of the Steamer"]};
				...
				{ 17, "s104306", "74650", "=q1=Mogu Fish Stew", "=ds=#sr# 600", "=ds="..ALIL["Way of the Pot"]};
				...
				{ 25, "s104312", "74656", "=q1=Chun Tian Spring Rolls", "=ds=#sr# 600", "=ds="..ALIL["Way of the Oven"]};
			...
			};
			{
				...
				{ 2, "s104300", "74646", "=q1=Black Pepper Ribs and Shrimp", "=ds=#sr# 600", "=ds="..ALIL["Way of the Grill"]};
		...
		["Normal"] = {
			{
				...
				{ 23, "s125123", "86074", "=q1=Spicy Vegetable Chips", "=ds=#sr# 500", "=ds="..ALIL["The Tillers"].." - "..AL["Exalted"]};
			...
			};
			{
				...
				{ 17, "s125120", "86073", "=q1=Spicy Salmon", "=ds=#sr# 500", "=ds="..ALIL["The Tillers"].." - "..AL["Exalted"]};
		...
		["Normal"] = {
			{
				...
				{ 24, "s15910", "12215", "=q1=Heavy Kodo Stew", "=ds=#sr# 200", "=ds="..AL["Vendor"]..": "..ALIL["Desolace"]};
			...
			};
			{
				...
				{ 12, "s6419", "5480", "=q1=Lean Venison", "=ds=#sr# 110", "=ds="..AL["Vendor"]..": "..ALIL["Desolace"]};
				{ 13, "s6418", "5479", "=q1=Crispy Lizard Tail", "=ds=#sr# 100", "=ds="..AL["Vendor"]..": "..ALIL["Northern Barrens"]};
				...
				{ 20, "s3371", "3220", "=q1=Blood Sausage", "=ds=#sr# 60", "=ds="..AL["Vendor"]..": "..ALIL["Stormwind City"]};
				...
				{ 27, "s6416", "5477", "=q1=Strider Stew", "=ds=#sr# 50", "=ds="..AL["Vendor"]..": "..ALIL["Northern Barrens"]};
				{ 28, "s21144", "17198", "=q1=Egg Nog", "=ds=#sr# 35", "=ds="..AL["Vendor"]};
				{ 29, "s6414", "5474", "=q1=Roasted Kodo Meat", "=ds=#sr# 35", "=ds="..AL["Vendor"]..": "..ALIL["Mulgore"]};
	...
	AtlasLoot_Data["CookingSpecial"] = {
		["Normal"] = {
			...
			};
			{
				...
				{ 4, "s124054", "75038", "=q1=Mad Brewer's Breakfast", "=ds=#sr# 600", "=ds="..ALIL["Way of the Brew"]};
				...
				{ 7, "s57435", "43004", "=q1=Critter Bites", "=ds=#sr# 400", "=ds="..AL["Vendor"]..": "..ALIL["Dalaran"]};
		...
		["Normal"] = {
			{
				...
				{ 3, "s125602", "87246", "=q1=Banquet of the Brew", "=ds=#sr# 575", "=ds="..ALIL["Way of the Brew"]};
				{ 4, "s125603", "87248", "=q1=Great Banquet of the Brew", "=ds=#sr# 575", "=ds="..ALIL["Way of the Brew"]};
				{ 5, "s125141", "87226", "=q1=Banquet of the Grill", "=ds=#sr# 575", "=ds="..ALIL["Way of the Grill"]};
				{ 6, "s125142", "87228", "=q1=Great Banquet of the Grill", "=ds=#sr# 575", "=ds="..ALIL["Way of the Grill"]};
				{ 7, "s125600", "87242", "=q1=Banquet of the Oven", "=ds=#sr# 575", "=ds="..ALIL["Way of the Oven"]};
				{ 8, "s125601", "87244", "=q1=Great Banquet of the Oven", "=ds=#sr# 575", "=ds="..ALIL["Way of the Oven"]};
				{ 9, "s125596", "87234", "=q1=Banquet of the Pot", "=ds=#sr# 575", "=ds="..ALIL["Way of the Pot"]};
				{ 10, "s125597", "87236", "=q1=Great Banquet of the Pot", "=ds=#sr# 575", "=ds="..ALIL["Way of the Pot"]};
				{ 11, "s125598", "87238", "=q1=Banquet of the Steamer", "=ds=#sr# 575", "=ds="..ALIL["Way of the Steamer"]};
				{ 12, "s125599", "87240", "=q1=Great Banquet of the Steamer", "=ds=#sr# 575", "=ds="..ALIL["Way of the Steamer"]};
				{ 13, "s125594", "87230", "=q1=Banquet of the Wok", "=ds=#sr# 575", "=ds="..ALIL["Way of the Wok"]};
				{ 14, "s125595", "87232", "=q1=Great Banquet of the Wok", "=ds=#sr# 575", "=ds="..ALIL["Way of the Wok"]};
		...
		["Normal"] = {
			{
				...
				{ 13, "s20626", "16766", "=q1=Undermine Clam Chowder", "=ds=#sr# 225", "=ds="..AL["Vendor"]..": "..ALIL["Tanaris"]};
			...
			};
			{
				...
				{ 24, "s13028", "10841", "=q1=Goldthorn Tea", "=ds=#sr# 175", "=ds="..ALIL["Razorfen Downs"]};
			};
		};
		info = {
		...
		["Normal"] = {
			{
				...
				{ 14, "s45765", "22449", "=q3=Void Shatter", "=ds=#sr# 360", "=ds="..AL["Vendor"]..": "..ALIL["Isle of Quel'Danas"]};
		...
		["Normal"] = {
			{
				...
				{ 10, "s30547", "23819", "=q1=Elemental Seaforium Charge", "=ds=#sr# 350", "=ds="..ALIL["The Consortium"].." - "..AL["Revered"] };
				...
				{ 17, "s19799", "16005", "=q1=Dark Iron Bomb", "=ds=#sr# 285", "=ds="..ALIL["Blackrock Depths"] };
	...
	AtlasLoot_Data["EngineeringMisc"] = {
		["Normal"] = {
			...
			};
			{
				...
				{ 4, "s23096", "18645", "=q2=Gnomish Alarm-O-Bot", "=ds=#sr# 265", "=ds="..ALIL["Blackrock Depths"]};
