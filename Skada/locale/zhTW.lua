...
L["Adds a background frame under the bars. The height of the background frame determines how many bars are shown. This will override the max number of bars setting."] = "新增一個計量條的背景框架。背景框架的高度將決定顯示多少個計量條。這會忽略計量條最多數量的設定。" -- Needs review
L["Aggressive combat detection"] = "雜兵戰鬥檢測"
L["All data has been reset."] = "所有資料已重置。"
L["Alternate color"] = "間隔的顏色" -- Needs review
L["Announce CC breaking to party"] = "控場被破除時通知到隊伍頻道中"
L["Appearance"] = "外觀"
L["Ask"] = "詢問"
L["Attack"] = "近戰攻擊"
L["Automatically switch to set 'Current' and this mode after a wipe."] = "清除後，自動切換至'目前的'模組。" -- Needs review
L["Automatically switch to set 'Current' and this mode when entering combat."] = "當進入戰鬥時，自動切換'目前的'以及選擇的模組。" -- Needs review
L["Average hit:"] = "平均值:"
L["Background"] = "背景"
...
L["CC breakers"] = "控場破除者"
L["CC breaks"] = "控場被破除"
L["Change"] = "變更" -- Needs review
L["Channel"] = "頻道"
L["Choose the alternate color of the bars."] = "選擇計量條間隔的顏色。" -- Needs review
...
L["Class icons"] = "職業圖示"
L["Click for"] = "點擊後為"
L["Clickthrough"] = "透過點擊" -- Needs review
L["Columns"] = "計量條上"
L["Combat mode"] = "戰鬥模組"
L["Combined"] = "組合的"
L["Condensed"] = "簡易的"
...
L["Controls the way large numbers are displayed."] = "控制數字的顯示位數。" -- Needs review
L["Create window"] = "建立視窗"
L["Critical"] = "爆擊" -- Needs review
L["Crushing"] = "碾壓"
L["Current"] = "目前的" -- Needs review
L["Damage"] = "傷害"
L["Damaged mobs"] = "怪物的損傷" -- Needs review
L["Damage done"] = "總傷害"
L["Damage done per player"] = "每位玩家的總傷害" -- Needs review
L["Damage from"] = "傷害來自" -- Needs review
L["Damage on"] = "傷害於"
...
L["Data feed"] = "資料來源"
L["Data resets"] = "資料重置"
L["Data segments to keep"] = "保留分割資料" -- Needs review
L["Death log"] = "死亡紀錄表"
L["Deaths"] = "死亡紀錄"
L["Deaths:"] = "死亡人數:"
...
L["Default"] = "預設值"
L["Deflect"] = "偏斜"
L["Delete segment"] = "刪除分割資料" -- Needs review
...
L["Do not warn while tanking"] = "坦怪時不警告" -- Needs review
L["Do you want to reset Skada?"] = "你要重置Skada嗎？"
L["DPS"] = "每秒傷害"
L["DTPS"] = "每秒承受的傷害" -- Needs review
L["Enable"] = "啟用"
...
L["Healing taken"] = "承受的治療" -- Needs review
L["Health"] = "生命力"
...
L["No"] = "否"
L["No mode or segment selected for report."] = "沒有選擇可報告的模組或分割資料。" -- Needs review
L["No mode selected for report."] = "沒有選擇可報告的模組。"
L["None"] = "無"
L["Number format"] = "數字位數" -- Needs review
L["Officer"] = "幹部"
...
L["'s Debuffs"] = "的減益"
L["%s dies"] = "%s已死亡"
L["Segment"] = "分割" -- Needs review
L["Segment time"] = "分割歷程" -- Needs review
L["Self"] = "自己"
L["Send report"] = "發送報告"
...
L["Shows a button for opening the menu in the window title bar."] = "在視窗標題條上顯示一個按鈕以便開啟選單。" -- Needs review
L["Shows a extra row with a summary in certain modes."] = "在某些模式的總結顯示額外一行。" -- Needs review
L["Shows numbers for relative ranks for modes where it is applicable."] = "在模組適當位置顯示相對排名。" -- Needs review
...
L["Show totals"] = "顯示統計" -- Needs review
L["Skada: Fights"] = "Skada:戰鬥" -- Needs review
...
L["Spell list"] = "法術列表"
L["Start new segment"] = "開始新的分割" -- Needs review
L["Subview rows"] = "資訊行數"
L["Switch to mode"] = "模組切換到"
L["Switch to segment"] = "轉換到分割資料" -- Needs review
L["targets"] = "目標"
...
L["The number of fight segments to keep. Persistent segments are not included in this."] = "保留多少戰鬥資料分割的數量，不包含連續的分割。" -- Needs review
...
L["Thick outline"] = "粗體"
L["This will cause the screen to flash as a threat warning."] = "威脅值警告時螢幕會閃爍。" -- Needs review
L["This will cause the screen to shake as a threat warning."] = "威脅值警告時螢幕會震動。" -- Needs review
L["This will play a sound as a threat warning."] = "威脅值警告時會撥放音效。" -- Needs review
L["Threat"] = "威脅值"
