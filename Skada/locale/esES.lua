...
L["Activity"] = "Actividad" -- Needs review
...
L["All Skada functionality is now in 1 addon folder."] = "Toda la funcionalidad de Skada está ahora en una carpeta de accesorio" -- Needs review
L["Alternate color"] = "Color alternativo"
L["Announce CC breaking to party"] = "Anunciar la ruptura de control de masas al grupo"
L["Appearance"] = "Apariencia"
L["Append a count to set names with duplicate mob names."] = "Agrega una cuenta a los nombres de colección con nombres duplicados de criaturas." -- Needs review
L["Ask"] = "Preguntar"
L["Attack"] = "Ataque"
...
L["Autostop"] = "Parar automáticamente" -- Needs review
L["Autostop description"] = "Automáticamente para el segmento actual después de que la mitad de los miembros de banda hayan muerto." -- Needs review
...
L["Click below and configure your '|cFFFF0000Disabled Modules|r'."] = "Haz clic abajo y configura tus '|cFFFF0000Módulos deshabilitados|r'." -- Needs review
...
L["Configure description"] = "Te permite configurar la ventana activa de Skada." -- Needs review
...
L["Controls the way set names are displayed."] = "Controla la manera en que los nombres de conjunto se muestran." -- Needs review
...
L["Deaths"] = "Muertes"
L["Deaths:"] = "Muertes:"
L["Debuffs"] = "Desventajas" -- Needs review
...
L["Disabled Modules"] = "Módulos deshabilitados" -- Needs review
...
L["DTPS"] = "DRPS"
L["Enable"] = "Habilitar"
L["ENABLED"] = "ACTIVADO" -- Needs review
L["Enables the title bar."] = "Habilita la barra de título"
L["Enemies"] = "Enemigos" -- Needs review
...
L["Include set name in title bar"] = "Incluir nombre establecido en la barra de título" -- Needs review
...
L["Missed"] = "Fallado"
L["Mode"] = "Modo"
L["Mode description"] = "Salta a un modo específico." -- Needs review
...
L["Number set duplicates"] = "Conjunto de número duplicados" -- Needs review
L["Officer"] = "Oficial"
...
L["Raid"] = "Banda"
L["RDPS"] = "DPS de Banda"
L["RealID"] = "ID real" -- Needs review
L["Reflect"] = "Reflejar"
L["Rename window"] = "Renombrar ventana"
L["Report"] = "Informar"
L["Report description"] = "Abre el diálogo que te permite informar de tus datos a otros de varias maneras." -- Needs review
L["reports the active mode"] = "Informa el modo activo"
L["Reset"] = "Restablecer"
L["Reset description"] = "Reinicia todos los datos de combate excepto aquellos marcados para mantener." -- Needs review
...
L["Role icons"] = "Iconos de rol" -- Needs review
L["'s "] = "De"
...
L["%s dies"] = "%s muere"
L["Segment"] = "Fragmento"
L["Segment description"] = "Descripción de segmento" -- Needs review
L["Segment time"] = "Fragmento de tiempo"
L["Self"] = "Propio"
L["Send report"] = "Enviar informe"
L["Set format"] = "Establecer formato" -- Needs review
...
L["Skada has changed!"] = "¡Skada ha cambiado!" -- Needs review
...
L["Skada will |cFFFF0000NOT|r function properly until you delete the following AddOns:"] = "Skada |cFFFF0000NO|r funcionará correctamente hasta que no borres los siguientes accesorios:" -- Needs review
...
L["Stop description"] = "Para o resume el segmento actual. Útil para descontar los datos después de una muerte del grupo. Puede ser establecido para que se pare automáticamente en las opciones." -- Needs review
...
L["This change requires a UI reload. Are you sure?"] = "Este cambio requiere una recarga de la interfaz. ¿Estás seguro?" -- Needs review
...
L["Tick the modules you want to disable."] = "Marca los módulos que quieras deshabilitar." -- Needs review
...
L["TotalHealing"] = "Sanación Total" -- Needs review
L["TPS"] = "APS"
L["Use class icons where applicable."] = "Usar iconos de clase cuando sea posible."
L["Use focus target"] = "Usar el objetivo del foco"
L["Use role icons where applicable."] = "Utilizar iconos de rol donde sea aplicable." -- Needs review
...
L["Whisper"] = "Susurro"
L["Whisper Target"] = "Susurrar objetivo" -- Needs review
L["Window"] = "Ventana"
