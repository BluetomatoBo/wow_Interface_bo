...
L["Bar display is the normal bar window used by most damage meters. It can be extensively styled."] = "Leistenanzeige ist das normale Leistenfenster, diese Anzeigeart wird von den meisten Schadensmetern verwendet. Sie kann optisch stark verändert werden." -- Needs review
...
L["Data text acts as an LDB data feed. It can be integrated in any LDB display such as Titan Panel or ChocolateBar. It also has an optional internal frame."] = "Der Datentext verhält sich wie ein DataBroker-Plugin. Es kann in eine beliebige LDB-Anzeige wie Titan Panel, ChocolateBar, Bazooka etc. integriert werden. Skada kann diesen Datentext auch ohne ein solches, zusätzliches Addon anzeigen." -- Needs review
...
L["Inline display is a horizontal window style."] = "Die einzeilige Anzeige ist ein horizontaler Fensterstil." -- Needs review
L["Instance"] = "Instanz"
