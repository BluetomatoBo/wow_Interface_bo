...
L["Announce CC breaking to party"] = "Объявлять сбитие контроля для группы" -- Needs review
...
L["Click below and configure your '|cFFFF0000Disabled Modules|r'."] = "Нажмите внизу и настройте свои '|cFFFF0000Отключенные модули|r'." -- Needs review
L["Click for"] = "Клик -"
...
L["DamageTaken"] = "Полученный урон" -- Needs review
...
L["Deaths"] = "Смерти"
L["Deaths:"] = "Смертей:"
L["Debuffs"] = "Дебаффы" -- Needs review
...
L["Detailed"] = "Детально"
L["Disable"] = "Отключить"
L["Disabled Modules"] = "Отключенные модули" -- Needs review
...
L["Immune"] = "Невоспр."
L["Include set"] = "Включая бой" -- Needs review
L["Include set name in title bar"] = "Отображать в полосе заголовка текущий бой" -- Needs review
...
L["Skada has changed!"] = "Skada изменилась!" -- Needs review
...
L["Skada will |cFFFF0000NOT|r function properly until you delete the following AddOns:"] = "Skada |cFFFF0000НЕ|r будет правильно работать, пока вы не удалите аддоны:" -- Needs review
...
L["This change requires a UI reload. Are you sure?"] = "Это изменение требует перезагрузки UI. Вы уверены?" -- Needs review
...
L["Tick the modules you want to disable."] = "Выберите модули, которые хотите выключить." -- Needs review
...
L["TotalHealing"] = "Общее иселение" -- Needs review
L["TPS"] = "УгВС"
