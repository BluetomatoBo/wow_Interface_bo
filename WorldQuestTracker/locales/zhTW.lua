...
L["S_MAPBAR_OPTIONSMENU_STATUSBAR_ONDISABLE"] = "輸入 '/wqt statusbar' 或介面底下的插件選項來恢復狀態列。"
L["S_MAPBAR_OPTIONSMENU_STATUSBAR_VISIBILITY"] = "顯示狀態列"
...
L["S_OPTIONS_MAPFRAME_SCALE_ENABLED"] = "啟用縮放地圖視窗大小"
