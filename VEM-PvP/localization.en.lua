...
--  General BG Options  --
--------------------------
L = VEM:GetModLocalization("Battlegrounds")
...
--  Arenas  --
--------------
L = VEM:GetModLocalization("Arenas")
