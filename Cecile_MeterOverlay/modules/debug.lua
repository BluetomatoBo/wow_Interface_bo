...
function mod:OnInitialize()
	...
	--module frame
	mod.frame = CreateFrame("Frame", Engine.Name.."_DBG_Frame", UIParent);
	...
	--move main window
	frame.title:SetScript("OnMouseDown",function (self) 
			self:GetParent():StartMoving();
		end);
	frame.title:SetScript("OnMouseUp",function (self) 
	...
	frame.sizer:SetScript("OnMouseDown",function (self)
	...
	frame.msg:SetScript("OnMouseWheel", mod.ScrollingFunction);
