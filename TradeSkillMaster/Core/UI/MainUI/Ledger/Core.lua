			...
			:AddChild(TSMAPI_FOUR.UI.NewElement("Frame", "right")
				...
				:AddChild(TSMAPI_FOUR.UI.NewElement("Frame", "perDay")
					...
					:AddChild(TSMAPI_FOUR.UI.NewElement("Text", "perDayAmount", "SUMMARY_NUM")
						:SetText(TSMAPI_FOUR.Money.ToString(TSM.Accounting.Transactions.GetAveragePrice(private.contextItemString, nil, "sale"), "OPT_PAD", "OPT_SEP"))
					)
					:AddChild(TSMAPI_FOUR.UI.NewElement("Text", "perDayAmount", "SUMMARY_NUM")
						:SetText(TSMAPI_FOUR.Money.ToString(TSM.Accounting.Transactions.GetAveragePrice(private.contextItemString, SECONDS_PER_DAY * 30, "sale"), "OPT_PAD", "OPT_SEP"))
					)
					:AddChild(TSMAPI_FOUR.UI.NewElement("Text", "perDayAmount", "SUMMARY_NUM")
						:SetText(TSMAPI_FOUR.Money.ToString(TSM.Accounting.Transactions.GetAveragePrice(private.contextItemString, SECONDS_PER_DAY * 7, "sale"), "OPT_PAD", "OPT_SEP"))
					)
				)
				:AddChild(TSMAPI_FOUR.UI.NewElement("Frame", "top")
					:SetLayout("HORIZONTAL")
					...
					:AddChild(TSMAPI_FOUR.UI.NewElement("Text", "perDayAmount", "SUMMARY_NUM")
						:SetText(TSMAPI_FOUR.Money.ToString(TSM.Accounting.Transactions.GetTotalPrice(private.contextItemString, nil, "sale"), "OPT_PAD", "OPT_SEP"))
					)
					:AddChild(TSMAPI_FOUR.UI.NewElement("Text", "perDayAmount", "SUMMARY_NUM")
						:SetText(TSMAPI_FOUR.Money.ToString(TSM.Accounting.Transactions.GetTotalPrice(private.contextItemString, SECONDS_PER_DAY * 30, "sale"), "OPT_PAD", "OPT_SEP"))
					)
					:AddChild(TSMAPI_FOUR.UI.NewElement("Text", "perDayAmount", "SUMMARY_NUM")
						:SetText(TSMAPI_FOUR.Money.ToString(TSM.Accounting.Transactions.GetTotalPrice(private.contextItemString, SECONDS_PER_DAY * 7, "sale"), "OPT_PAD", "OPT_SEP"))
					)
				)
				:AddChild(TSMAPI_FOUR.UI.NewElement("Frame", "total")
					:SetLayout("HORIZONTAL")
				...
				:AddChild(TSMAPI_FOUR.UI.NewElement("Frame", "perDay")
					...
					:AddChild(TSMAPI_FOUR.UI.NewElement("Text", "perDayAmount", "SUMMARY_NUM")
						:SetText(TSMAPI_FOUR.Money.ToString(TSM.Accounting.Transactions.GetAveragePrice(private.contextItemString, nil, "buy"), "OPT_PAD", "OPT_SEP"))
					)
					:AddChild(TSMAPI_FOUR.UI.NewElement("Text", "perDayAmount", "SUMMARY_NUM")
						:SetText(TSMAPI_FOUR.Money.ToString(TSM.Accounting.Transactions.GetAveragePrice(private.contextItemString, SECONDS_PER_DAY * 30, "buy"), "OPT_PAD", "OPT_SEP"))
					)
					:AddChild(TSMAPI_FOUR.UI.NewElement("Text", "perDayAmount", "SUMMARY_NUM")
						:SetText(TSMAPI_FOUR.Money.ToString(TSM.Accounting.Transactions.GetAveragePrice(private.contextItemString, SECONDS_PER_DAY * 7, "buy"), "OPT_PAD", "OPT_SEP"))
					)
				)
				:AddChild(TSMAPI_FOUR.UI.NewElement("Frame", "top")
					:SetLayout("HORIZONTAL")
					...
					:AddChild(TSMAPI_FOUR.UI.NewElement("Text", "perDayAmount", "SUMMARY_NUM")
						:SetText(TSMAPI_FOUR.Money.ToString(TSM.Accounting.Transactions.GetTotalPrice(private.contextItemString, nil, "buy"), "OPT_PAD", "OPT_SEP"))
					)
					:AddChild(TSMAPI_FOUR.UI.NewElement("Text", "perDayAmount", "SUMMARY_NUM")
						:SetText(TSMAPI_FOUR.Money.ToString(TSM.Accounting.Transactions.GetTotalPrice(private.contextItemString, SECONDS_PER_DAY * 30, "buy"), "OPT_PAD", "OPT_SEP"))
					)
					:AddChild(TSMAPI_FOUR.UI.NewElement("Text", "perDayAmount", "SUMMARY_NUM")
						:SetText(TSMAPI_FOUR.Money.ToString(TSM.Accounting.Transactions.GetTotalPrice(private.contextItemString, SECONDS_PER_DAY * 7, "buy"), "OPT_PAD", "OPT_SEP"))
					)
				)
			)
		)
