...
L:SetOptionLocalization({
	...
	SetIconOnWS	= VEM_CORE_AUTO_ICONS_OPTION_TEXT:format(116784),
	SetIconOnAR	= VEM_CORE_AUTO_ICONS_OPTION_TEXT:format(116417)
})
...
L:SetOptionLocalization({
	...
	SetIconOnVoodoo		= VEM_CORE_AUTO_ICONS_OPTION_TEXT:format(122151),
...
L:SetOptionLocalization({
	...
	SetIconOnDestabilized	= VEM_CORE_AUTO_ICONS_OPTION_TEXT:format(132226),
