if GetLocale() == "deDE" then
	...
	String = {
		...
		ExtraPassengerMounts = "Passagierreittiere", -- Needs review
		...
		GlobalExclusionsDescription = "Reittiere werden immer ignoriert. Selbst dann, wenn die hier angegebenen Reittiere als Favoriten festgelegt wurden, werden sie nicht verwendet.", -- Needs review
		GlobalFavorites = "Globale Favoriten",
		GlobalPreferences = "Globale Präferenzen",
		GlobalZoneDescription = "Die hier definierten bevorzugten Reittiere werden nur verwendet, wenn keine zonenspezifischen Favoriten für die Zone definiert sind, in der du dich gerade befindest.", -- Needs review
		...
		NoShapeInRandom = "Gestaltwandlung und Reittiere nicht gemeinsam in einer Zufallsliste verwenden.", -- Needs review
		PaladinOptions = "Paladin-Einstellungen",
		RemoveBuffs = "Entferne Buffs die das Aufsitzen verhindern",
		RemoveBuffs_Long = "GoGoMount wird versuchen, aus Zaubern und Gegenständen resultierende Stärkungszauber und Gestaltwandlungen zu entfernen, die das Aufsteigen verhindern. Dies funktioniert nur für bekannte Stärkungszauber und in einigen Fällen muss der GoGoMount-Button zweimal geklickt werden.", -- Needs review
		ShamanOptions = "Schamanen-Optionen", -- Needs review
		ShamanSingleClick = "Mit einem Klick aus der Geisterwolf-Form aufsitzen anstatt abzusitzen", -- Needs review
		...
		ZoneExclusionsDescription = "Zonenspezifische Ausnahmen funktionieren genauso wie die globalen Ausnahmen, allerdings nur für die angegebene Zone. Alle Reittiere, die unten als Ausnahme für die Zone, in der du gerade bist, markiert sind, werden niemals verwendet.", -- Needs review
	},
	Talent = {
	...
	Zone = {
		...
		TenebrousCavern = "Schattenhöhle", -- Needs review
		ThalassianPass = "Thalassischer Pass",
		ThalassianRange = "Thalassischer Pass", -- Needs review
		TheCerebrillum = "Cerebrillum ", -- Needs review
