...
function flashFrame:Show(red, green, blue, dur, alpha)
	if not VEM.Options.ShowFlashFrame then return end
...
function flashFrame:Shake(red, green, blue, alpha)
	if not VEM.Options.ShowShakeFrame then return end	
