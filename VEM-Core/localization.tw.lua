...
VEM_CORE_LOAD_GUI_COMBAT			= "圖形介面不能在戰鬥中初始化。圖形介面將在戰鬥後自動讀取，這樣就能夠在戰鬥中使用。"
...
VEM_CORE_COMBAT_STARTED_IN_PROGRESS	= "開戰%s已進行的戰鬥。祝好運與盡興! :)"
VEM_CORE_SCENARIO_STARTED			= "%s開始。祝好運與盡興! :)"
VEM_CORE_BOSS_DOWN					= "擊敗%s，經過%s!"
VEM_CORE_BOSS_DOWN_I				= "擊敗%s!你已勝利了%d次。"
VEM_CORE_BOSS_DOWN_L				= "擊敗%s!本次經過%s，上次經過%s，最快紀錄為%s。你總共戰勝了%d次。"
VEM_CORE_BOSS_DOWN_NR				= "擊敗%s!經過%s! 這是一個新記錄! (舊紀錄為%s) 你總共戰勝了%d次。"
VEM_CORE_SCENARIO_COMPLETE			= "%s完成!經過%s!"
VEM_CORE_SCENARIO_COMPLETE_L		= "%s完成!本次經過%s，上次經過%s，最快紀錄為%s。你總共完成了%d次。"
VEM_CORE_SCENARIO_COMPLETE_NR		= "%s完成!經過%s! 這是一個新記錄! (舊紀錄為%s) 你總共完成了%d次。"
VEM_CORE_COMBAT_ENDED_AT			= "%s(%s)的戰鬥經過%s結束。"
VEM_CORE_COMBAT_ENDED_AT_LONG		= "%s(%s)的戰鬥經過%s結束。你在這個難度總共滅團了%d次。"
VEM_CORE_SCENARIO_ENDED_AT			= "%s結束!經過%s!"
VEM_CORE_SCENARIO_ENDED_AT_LONG		= "%s結束!本次經過%s，你已有共%d次未完成的嘗試在這個難度裡。"
...
VEM_CORE_GENERIC_WARNING_DUPLICATE	= "%s之一"
VEM_CORE_GENERIC_WARNING_BERSERK	= "%s%s後狂暴"
VEM_CORE_GENERIC_TIMER_BERSERK		= "狂暴"
VEM_CORE_OPTION_TIMER_BERSERK			= "計時器：$spell:26662"
VEM_CORE_GENERIC_TIMER_COMBAT		= "戰鬥開始"
VEM_CORE_OPTION_TIMER_COMBAT			= "計時器：戰鬥開始"
...
VEM_CORE_UPDATEREMINDER_HEADER			= "你的Voice Encounter Mods已經過期。\n你可以在此網址下載到新版本%s(r%d)："
VEM_CORE_UPDATEREMINDER_HEADER_ALPHA	= "你的alpha版本Voice Encounter Mods已經過期。\n 你至少落後%d個測試版本。建議VEM使用者使用最新的alpha或最新的穩定版本。過期的alpha版本可能會有低落或未完成的功能。"
...
VEM_PIZZA_ERROR_USAGE				= "命令：/vem [broadcast] timer <時間（秒）> <文字>"
...
--	"/vem version2: 進行團隊範圍內的版本檢測及密語通知已過期的成員（也可使用: ver2）。",
	...
	"/vem timer <x> <文字>：開始一個以<文字>為名稱的時間為<x>秒的計時器。",
...
VEM_CORE_ACHIEVEMENT_TIMER_SPEED_KILL 		= "成就：最速勝利"
...
VEM_CORE_AUTO_COUNTOUT_OPTION_TEXT		= "正計時：$spell:%s的持續時間"
VEM_CORE_AUTO_YELL_OPTION_TEXT			= "自動喊話：當你中了$spell:%s時"
...
VEM_INSTANCE_INFO_SHOW_RESULTS		= "回复請求的玩家: %s\n|HVEM:showRaidIdResults|h|cff3588ff[查看結果]|r|h"

VEM_CORE_LAG_CHECKING				= "延遲檢測--五秒後反饋結果..."
VEM_CORE_LAG_HEADER					= "Voice Encounter Mods - 延遲檢測"
VEM_CORE_LAG_ENTRY					= "%s：世界延時[%d毫秒] / 本地延時[%d毫秒]"
VEM_CORE_LAG_FOOTER					= "未反饋此次檢測的團員:%s"
...
VEM_CORE_SOUNDGRIL_TEXT_YIKE		= "    夏一可，又名可可超人，女，真名不詳，《我叫MT》中法師和美屢的配音，魔獸世界知名解說，部落控。2009年進入西南科技大學。高三時因參加唱響艾澤拉斯而成名。"
