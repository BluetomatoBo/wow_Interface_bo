...
frame:SetScript("OnDragStop", function(self)
	...
	VEM.Options.ArrowPoint = point
	VEM.Options.ArrowPosX = x
	VEM.Options.ArrowPosY = y
end)
local arrow = frame:CreateTexture(nil, "OVERLAY")
arrow:SetTexture("Interface\\AddOns\\VEM-Core\\textures\\arrows\\Arrow.blp")
...
function VEM.Arrow:Move()
	...
	frame:Show()
	VEM.Bars:CreateBar(25, VEM_ARROW_MOVABLE, "Interface\\Icons\\Spell_Holy_BorrowedTime")
	VEM:Unschedule(endMove)
