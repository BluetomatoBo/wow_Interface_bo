local mod	= VEM:NewMod(818, "VEM-ThroneofThunder", nil, 362)
...
local function lightchoose()
	if ((rgbcount == 1) and (mod.Options.optDD == "DD1")) or ((rgbcount == 2) and (mod.Options.optDD == "DD3")) or ((rgbcount == 3) and (mod.Options.optDD == "DD2")) or (mod.Options.optDD == "HDD1") then
		sndWOP:Play("Interface\\AddOns\\VEM-Core\\extrasounds\\"..VEM.Options.CountdownVoice.."\\ex_tt_hsfd.mp3") --紅色分擔
	...
	elseif ((rgbcount == 1) and ((mod.Options.optDD == "DD2") or (mod.Options.optDD == "HDD3"))) or ((rgbcount == 2) and ((mod.Options.optDD == "DD1") or (mod.Options.optDD == "HDD3"))) or ((rgbcount == 3) and ((mod.Options.optDD == "DD3") or (mod.Options.optDD == "HDD2"))) then
		sndWOP:Play("Interface\\AddOns\\VEM-Core\\extrasounds\\"..VEM.Options.CountdownVoice.."\\ex_tt_hufd.mp3") --黃色分擔
		if mod.Options.HudMAP then
	...
	elseif ((rgbcount == 1) and ((mod.Options.optDD == "DD3") or (mod.Options.optDD == "HDD2"))) or ((rgbcount == 2) and ((mod.Options.optDD == "DD2") or (mod.Options.optDD == "HDD2"))) or ((rgbcount == 3) and ((mod.Options.optDD == "DD1") or (mod.Options.optDD == "HDD3"))) then
		sndWOP:Play("Interface\\AddOns\\VEM-Core\\extrasounds\\"..VEM.Options.CountdownVoice.."\\ex_tt_lsfd.mp3") --藍色分擔
		if mod.Options.HudMAP then
...
local function warnDarkParasiteTargets()
	...
	if UnitDebuff("player", GetSpellInfo(133597)) then
		sndWOP:Play("Interface\\AddOns\\VEM-Core\\extrasounds\\"..VEM.Options.CountdownVoice.."\\ex_tt_nbjs.mp3")--你被寄生		
	elseif mod:IsHealer() then
		sndWOP:Play("Interface\\AddOns\\VEM-Core\\extrasounds\\"..VEM.Options.CountdownVoice.."\\ex_tt_hajs.mp3")--黑暗寄生
	end
end
...
local function BeamEnded()
	...
	if mod:IsDifficulty("lfr25") then
		...
		sndWOP:Schedule(63, "Interface\\AddOns\\VEM-Core\\extrasounds\\"..VEM.Options.CountdownVoice.."\\ex_tt_syg.mp3") --三原光準備
		sndWOP:Schedule(64, "Interface\\AddOns\\VEM-Core\\extrasounds\\"..VEM.Options.CountdownVoice.."\\countthree.mp3")
		sndWOP:Schedule(65, "Interface\\AddOns\\VEM-Core\\extrasounds\\"..VEM.Options.CountdownVoice.."\\counttwo.mp3")
		...
		sndWOP:Schedule(36, "Interface\\AddOns\\VEM-Core\\extrasounds\\"..VEM.Options.CountdownVoice.."\\ex_tt_syg.mp3") --三原光準備
		sndWOP:Schedule(37, "Interface\\AddOns\\VEM-Core\\extrasounds\\"..VEM.Options.CountdownVoice.."\\countthree.mp3")
		sndWOP:Schedule(38, "Interface\\AddOns\\VEM-Core\\extrasounds\\"..VEM.Options.CountdownVoice.."\\counttwo.mp3")
...
function mod:OnCombatStart(delay)
	...
	sndWOP:Schedule(37-delay, "Interface\\AddOns\\VEM-Core\\extrasounds\\"..VEM.Options.CountdownVoice.."\\ex_tt_syg.mp3") --三原光準備
	sndWOP:Schedule(38-delay, "Interface\\AddOns\\VEM-Core\\extrasounds\\"..VEM.Options.CountdownVoice.."\\countthree.mp3")
	sndWOP:Schedule(39-delay, "Interface\\AddOns\\VEM-Core\\extrasounds\\"..VEM.Options.CountdownVoice.."\\counttwo.mp3")
	sndWOP:Schedule(40-delay, "Interface\\AddOns\\VEM-Core\\extrasounds\\"..VEM.Options.CountdownVoice.."\\countone.mp3")
...
--BH DELETE		soundLingeringGaze:Play()
	...
	elseif args.spellId == 133798 then
		if (args.amount or 1) >= 2 and (args.amount or 1) % 2 == 0 then
			sndWOP:Play("Interface\\AddOns\\VEM-Core\\extrasounds\\"..VEM.Options.CountdownVoice.."\\ex_tt_bmdx.mp3")--幫忙擋線
		end
		if args:IsPlayer() then
...
function mod:CHAT_MSG_MONSTER_EMOTE(msg, npc, _, _, target)
	if (npc == crimsonFog or npc == amberFog or npc == azureFog) and self:AntiSpam(1, npc) then
		if self:IsDifficulty("lfr25") and npc == azureFog and not lfrAzureFogRevealed then
			...
			sndWOP:Play("Interface\\AddOns\\VEM-Core\\extrasounds\\"..VEM.Options.CountdownVoice.."\\ex_lan.mp3") --藍色快打
	...
	elseif msg:find("spell:133795") then--Does show in combat log, but emote gives targetname 3 seconds earlier.
			...
			if lightphase then
				if lightcheck[target] then
					if lightcheck[target] == "blue" then
						sndWOP:Play("Interface\\AddOns\\VEM-Core\\extrasounds\\"..VEM.Options.CountdownVoice.."\\ex_tt_lqxx.mp3") --藍區吸血
					elseif lightcheck[target] == "red" then
						sndWOP:Play("Interface\\AddOns\\VEM-Core\\extrasounds\\"..VEM.Options.CountdownVoice.."\\ex_tt_hqxx.mp3") --紅區吸血
					elseif lightcheck[target] == "yellow" then
						sndWOP:Play("Interface\\AddOns\\VEM-Core\\extrasounds\\"..VEM.Options.CountdownVoice.."\\ex_tt_yqxx.mp3") --黃區吸血
					end
				else
					sndWOP:Play("Interface\\AddOns\\VEM-Core\\extrasounds\\"..VEM.Options.CountdownVoice.."\\ex_tt_smxq.mp3") --生命吸取
				end
			else
				sndWOP:Play("Interface\\AddOns\\VEM-Core\\extrasounds\\"..VEM.Options.CountdownVoice.."\\ex_tt_smxq.mp3")
			end
		end		
		...
		if self.Options.InfoFrameLife then
			VEM.InfoFrame:SetHeader(GetSpellInfo(133795))
			VEM.InfoFrame:Show(5, "playerdebuffstacks", 133798)
		end
		self:Schedule(21, HideInfoFrame)
		if mod.Options.DXsound then
			linemaker[target] = register(VEMHudMap:AddEdge(1, 0, 0, 1, 1, "player", target))
	...
	elseif msg:find("spell:134169") then
		...
		sndWOP:Schedule(51, "Interface\\AddOns\\VEM-Core\\extrasounds\\"..VEM.Options.CountdownVoice.."\\countfive.mp3")
		sndWOP:Schedule(52, "Interface\\AddOns\\VEM-Core\\extrasounds\\"..VEM.Options.CountdownVoice.."\\countfour.mp3")	
		sndWOP:Schedule(53, "Interface\\AddOns\\VEM-Core\\extrasounds\\"..VEM.Options.CountdownVoice.."\\countthree.mp3")
		sndWOP:Schedule(54, "Interface\\AddOns\\VEM-Core\\extrasounds\\"..VEM.Options.CountdownVoice.."\\counttwo.mp3")
		sndWOP:Schedule(55, "Interface\\AddOns\\VEM-Core\\extrasounds\\"..VEM.Options.CountdownVoice.."\\countone.mp3")
...
function mod:UNIT_AURA(uId)
	if UnitDebuff(uId, blueTracking) then
		local name = VEM:GetUnitFullName(uId)
...
function mod:UNIT_DIED(args)
	...
	if cid == 69050 then--Crimson Fog
		...
		if totalFogs >= 1 then
			...
			if lastRed == UnitName("player") then
				sndWOP:Play("Interface\\AddOns\\VEM-Core\\extrasounds\\"..VEM.Options.CountdownVoice.."\\cntnuemove.mp3") --紅怪死亡
			end
