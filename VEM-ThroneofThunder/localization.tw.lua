...
L:SetOptionLocalization({
	...
	SetIconOnCharge			= VEM_CORE_AUTO_ICONS_OPTION_TEXT:format(136769)
})
...
L:SetOptionLocalization({
	...
	warnPossessed		= VEM_CORE_AUTO_ANNOUNCE_OPTIONS.target:format(136442),
	specWarnPossessed	= VEM_CORE_AUTO_SPEC_WARN_OPTIONS.switch:format(136442),
	warnSandBolt		= VEM_CORE_AUTO_ANNOUNCE_OPTIONS.target:format(136189),
	PHealthFrame		= "為$spell:136442消散顯示剩餘血量框架(需要首領血量框架開啟)",
	RangeFrame			= "顯示距離框架",
	SetIconOnBitingCold	= VEM_CORE_AUTO_ICONS_OPTION_TEXT:format(136992),
	SetIconOnFrostBite	= VEM_CORE_AUTO_ICONS_OPTION_TEXT:format(136922)
})

------------
-- Tortos --
------------
L= VEM:GetModLocalization(825)
...
L:SetOptionLocalization({	
	warnKickShell			= VEM_CORE_AUTO_ANNOUNCE_OPTIONS.spell:format(134031),
	SoundWOP				= "語音警告：重要技能",
...
L:SetOptionLocalization({
	...
	SetIconOnCinders		= VEM_CORE_AUTO_ICONS_OPTION_TEXT:format(139822),
	SetIconOnTorrentofIce	= VEM_CORE_AUTO_ICONS_OPTION_TEXT:format(139889)
})
...
L:SetOptionLocalization({
	SoundWOP		= "語音警告：重要技能",
	warnFlock		= VEM_CORE_AUTO_ANNOUNCE_OPTIONS.count:format("ej7348"),
	specWarnFlock	= VEM_CORE_AUTO_SPEC_WARN_OPTIONS.switch:format("ej7348"),
	timerFlockCD	= VEM_CORE_AUTO_TIMER_OPTIONS.nextcount:format("ej7348"),
...
L:SetOptionLocalization({
	SoundWOP					= "語音警告：重要技能",
	warnBeam					= "提示射線目標",
	specWarnBlueBeam			= VEM_CORE_AUTO_SPEC_WARN_OPTIONS.spell:format(139202),
	optDD						= "三元光分擔策略",
	...
	specWarnDisintegrationBeam	= VEM_CORE_AUTO_SPEC_WARN_OPTIONS.spell:format("ej6882"),
	ArrowOnBeam					= "VEM箭頭：$journal:6882的轉動方向",
	soundhold					= "黑暗寄生經過多少秒時提示你開自保(30-剩幾秒驅散-自保持續時間)",
	sounddisp					= "黑暗寄生剩餘多少秒時提示你幫忙驅散(治療)",
	specWarnHold				= "特別警告：黑暗寄生開自保",
	xx1							= "當你被吸血一層時喊話",
	xx2							= "當你被吸血兩層時喊話",
	xx3							= "當你被吸血超過三層時喊話(VEM會自動在結尾為你顯示層數)",
	lifeA						= "當你被吸血兩層時密語此目標擋線",
	lifeB						= "當你被吸血兩層時密語此目標擋線",
	SetIconRays					= VEM_CORE_AUTO_ICONS_OPTION_TEXT:format("ej6891"),
	SetIconLifeDrain			= VEM_CORE_AUTO_ICONS_OPTION_TEXT:format(133795),
	SetIconOnParasite			= VEM_CORE_AUTO_ICONS_OPTION_TEXT:format(133597),
...
L:SetOptionLocalization({
	warnDeadZone	= VEM_CORE_AUTO_ANNOUNCE_OPTIONS.spell:format(137229),
	SetIconOnLightningStorm	= VEM_CORE_AUTO_ICONS_OPTION_TEXT:format(136192),
	SoundWOP		= "語音警告：重要技能",
...
L:SetOptionLocalization({
	...
	StaticShockArrow	= "VEM箭頭：$spell:135695",
	OverchargeArrow		= "VEM箭頭：$spell:136295",
	SetIconOnOvercharge	= VEM_CORE_AUTO_ICONS_OPTION_TEXT:format(136295),
	SetIconOnStaticShock= VEM_CORE_AUTO_ICONS_OPTION_TEXT:format(135695)
})

------------
-- Ra-den --
------------
L= VEM:GetModLocalization(831)
...
L:SetOptionLocalization({
	...
	SetIconOnUnstableVita	= VEM_CORE_AUTO_ICONS_OPTION_TEXT:format(138297),
	SetIconOnUnstableAnima	= VEM_CORE_AUTO_ICONS_OPTION_TEXT:format(138288)
})
