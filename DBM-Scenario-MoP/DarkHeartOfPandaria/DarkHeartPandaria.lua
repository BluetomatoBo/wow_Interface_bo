...
local warnSpellShatter			= mod:NewCastAnnounce(141421, 3, 2, nil, mod:IsSpellCaster())--Spell interrupt. Cast time is long enough to /stopcasting this
...
local specWarnSpellShatter		= mod:NewSpecialWarningCast(141421, mod:IsSpellCaster())
