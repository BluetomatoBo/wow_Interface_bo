...
L:SetOptionLocalization({
	...
	SetIconOnPrison		= VEM_CORE_AUTO_ICONS_OPTION_TEXT:format(117436),
...
L:SetOptionLocalization ({
	...
	SetIconOnWS			= VEM_CORE_AUTO_ICONS_OPTION_TEXT:format(120629)
})
