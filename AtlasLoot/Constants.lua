...
ATLASLOOT_DEATHKNIGHT_COLOR	= "|cffc41f3b";
ATLASLOOT_DEMONHUNTER_COLOR	= "|cffa330c9";
ATLASLOOT_DRUID_COLOR 		= "|cffff7d0a";
ATLASLOOT_HUNTER_COLOR 		= "|cffabd473";
ATLASLOOT_MAGE_COLOR 		= "|cff3fc7eb";
ATLASLOOT_MONK_COLOR 		= "|cff00ff96";
ATLASLOOT_PALADIN_COLOR 	= "|cfff58cba";
ATLASLOOT_PRIEST_COLOR 		= "|cffffffff";
ATLASLOOT_ROGUE_COLOR 		= "|cfffff569";
ATLASLOOT_SHAMAN_COLOR 		= "|cff0070de";
ATLASLOOT_WARLOCK_COLOR 	= "|cff8788ee";
ATLASLOOT_WARRIOR_COLOR 	= "|cffc79c6e";
