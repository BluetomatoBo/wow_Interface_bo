local mod	= VEM:NewMod(713, "VEM-HeartofFear", nil, 330)
...
function mod:OnCombatStart(delay)
	...
	sndFS:Schedule(5, "Interface\\AddOns\\VEM-Core\\extrasounds\\"..VEM.Options.CountdownVoice.."\\countthree.mp3")
	sndFS:Schedule(6, "Interface\\AddOns\\VEM-Core\\extrasounds\\"..VEM.Options.CountdownVoice.."\\counttwo.mp3")
	sndFS:Schedule(7, "Interface\\AddOns\\VEM-Core\\extrasounds\\"..VEM.Options.CountdownVoice.."\\countone.mp3")
	table.wipe(PheromonesMarkers)	
	if self:IsDifficulty("heroic10", "heroic25") then
		timerCrushCD:Start(30-delay, Crushcount + 1)
		sndZN:Schedule(25.5, "Interface\\AddOns\\VEM-Core\\extrasounds\\"..VEM.Options.CountdownVoice.."\\countfive.mp3")
		sndZN:Schedule(26.5, "Interface\\AddOns\\VEM-Core\\extrasounds\\"..VEM.Options.CountdownVoice.."\\countfour.mp3")
		sndZN:Schedule(27.5, "Interface\\AddOns\\VEM-Core\\extrasounds\\"..VEM.Options.CountdownVoice.."\\countthree.mp3")
		sndZN:Schedule(28.5, "Interface\\AddOns\\VEM-Core\\extrasounds\\"..VEM.Options.CountdownVoice.."\\counttwo.mp3")
		sndZN:Schedule(29.5, "Interface\\AddOns\\VEM-Core\\extrasounds\\"..VEM.Options.CountdownVoice.."\\countone.mp3")
		if MyJS() then
			specWarnJSA:Schedule(24)
			sndWOP:Schedule(24, "Interface\\AddOns\\VEM-Core\\extrasounds\\"..VEM.Options.CountdownVoice.."\\defensive.mp3") --注意減傷
		end
	end
end
...
function mod:SPELL_AURA_APPLIED(args)
	...
	elseif args:IsSpellID(122835) then
		...
		if args:IsPlayer() then
			...
			if self.Options.HudMAP then
				...
				PheromonesMarkers[args.destName] = register(VEMHudMap:PlaceRangeMarkerOnPartyMember("targeting", args.destName, 2, nil, 0, 1, 0, 1):SetLabel(spelltext))
			end
		end
	...
	elseif args:IsSpellID(123081) then
		...
		if mod.Options.InfoFrame then
			VEM.InfoFrame:SetHeader(GetSpellInfo(123081))
		...
		if (args.amount or 1) == 3 then
			if mod.Options.optFLM == args.destName then
				...
				sndWOP:Play("Interface\\AddOns\\VEM-Core\\extrasounds\\"..VEM.Options.CountdownVoice.."\\ex_mop_xxszb.mp3") --信息素準備
...
function mod:SPELL_AURA_REMOVED(args)
	...
	elseif args:IsSpellID(122835) then
		...
		if args:IsPlayer() then
			sndWOP:Play("Interface\\AddOns\\VEM-Core\\extrasounds\\"..VEM.Options.CountdownVoice.."\\targetchange.mp3")--目標改變
		end
...
function mod:SPELL_CAST_START(args)
	if args:IsSpellID(122735) then
		...
		sndFS:Cancel("Interface\\AddOns\\VEM-Core\\extrasounds\\"..VEM.Options.CountdownVoice.."\\countthree.mp3")
		sndFS:Cancel("Interface\\AddOns\\VEM-Core\\extrasounds\\"..VEM.Options.CountdownVoice.."\\counttwo.mp3")
		sndFS:Cancel("Interface\\AddOns\\VEM-Core\\extrasounds\\"..VEM.Options.CountdownVoice.."\\countone.mp3")
		sndFS:Play("Interface\\AddOns\\VEM-Core\\extrasounds\\"..VEM.Options.CountdownVoice.."\\ex_mop_hj.mp3") --揮擊
...
function mod:CHAT_MSG_RAID_BOSS_EMOTE(msg, _, _, _, target)
	if msg:find("spell:122774") then
		if self:AntiSpam(3, 2) then
			...
			sndWOP:Play("Interface\\AddOns\\VEM-Core\\extrasounds\\"..VEM.Options.CountdownVoice.."\\ex_mop_nyjd.mp3") --碾壓
		end
		timerCrush:Start()
		if msg:find(L.UnderHim) and target == UnitName("player") then
			...
			sndWOP:Play("Interface\\AddOns\\VEM-Core\\extrasounds\\"..VEM.Options.CountdownVoice.."\\ex_mop_lkzq.mp3") --離開紫圈
		end
		if msg:find(L.Heroicrush) then
			timerCrushCD:Cancel()
			sndZN:Cancel("Interface\\AddOns\\VEM-Core\\extrasounds\\"..VEM.Options.CountdownVoice.."\\countfive.mp3")
			sndZN:Cancel("Interface\\AddOns\\VEM-Core\\extrasounds\\"..VEM.Options.CountdownVoice.."\\countfour.mp3")
			sndZN:Cancel("Interface\\AddOns\\VEM-Core\\extrasounds\\"..VEM.Options.CountdownVoice.."\\countthree.mp3")
			sndZN:Cancel("Interface\\AddOns\\VEM-Core\\extrasounds\\"..VEM.Options.CountdownVoice.."\\counttwo.mp3")
			sndZN:Cancel("Interface\\AddOns\\VEM-Core\\extrasounds\\"..VEM.Options.CountdownVoice.."\\countone.mp3")
			timerCrushCD:Start(37.5, Crushcount + 1)
			sndZN:Schedule(33, "Interface\\AddOns\\VEM-Core\\extrasounds\\"..VEM.Options.CountdownVoice.."\\countfive.mp3")
			sndZN:Schedule(34, "Interface\\AddOns\\VEM-Core\\extrasounds\\"..VEM.Options.CountdownVoice.."\\countfour.mp3")
			sndZN:Schedule(35, "Interface\\AddOns\\VEM-Core\\extrasounds\\"..VEM.Options.CountdownVoice.."\\countthree.mp3")
			sndZN:Schedule(36, "Interface\\AddOns\\VEM-Core\\extrasounds\\"..VEM.Options.CountdownVoice.."\\counttwo.mp3")
			sndZN:Schedule(37, "Interface\\AddOns\\VEM-Core\\extrasounds\\"..VEM.Options.CountdownVoice.."\\countone.mp3")
			if MyJS() then
				specWarnJSA:Schedule(32)
				sndWOP:Schedule(32, "Interface\\AddOns\\VEM-Core\\extrasounds\\"..VEM.Options.CountdownVoice.."\\defensive.mp3") --注意減傷
			end
		end
