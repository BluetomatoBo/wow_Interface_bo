...
------------
L= VEM:GetModLocalization(745)

L:SetOptionLocalization({
	specwarnPlatform	= "Show special warning when boss changes platforms",
	ArrowOnAttenuation	= "Show VEM Arrow during $spell:127834 to indicate which direction to move",
	...
	MindControlIcon		= VEM_CORE_AUTO_ICONS_OPTION_TEXT:format(122740),
...
L:SetOptionLocalization({
	UnseenStrikeArrow	= "Show VEM Arrow when someone is affected by $spell:122949",
...
L:SetOptionLocalization({
	...
	PheromonesIcon	= VEM_CORE_AUTO_ICONS_OPTION_TEXT:format(122835),
...
L:SetOptionLocalization({
	...
	APArrow				= "VEM arrow: $spell:121881",
	...
	AmberPrisonIcons	= VEM_CORE_AUTO_ICONS_OPTION_TEXT:format(121885)
})
...
L:SetOptionLocalization({
	...
	warnReshapeLife				= VEM_CORE_AUTO_ANNOUNCE_OPTIONS.target:format(122784, GetSpellInfo(122784)),
...
L:SetOptionLocalization({
	...
	StickyResinIcons	= VEM_CORE_AUTO_ICONS_OPTION_TEXT:format(124097),
...
--  Trash  --
-------------
L = VEM:GetModLocalization("HoFTrash")
