...
local function myColorCallback(restore)
	...
	_NPCScanOverlayKeyColors[modify_id].r = r
	_NPCScanOverlayKeyColors[modify_id].g = g
	_NPCScanOverlayKeyColors[modify_id].b = b
end
...
local function OnShow ( ... )
	if Count == 0 then
		for x,y in pairs(_NPCScanOverlayKeyColors) do
			AddLine( y.r,y.g,y.b)
		end
	end
end
