...
private.L["CONFIG_COLORLIST_INST"] = "Cliquez sur une ligne pour définir sa couleur." -- Needs review
private.L["CONFIG_COLORLIST_LABEL"] = "Couleurs des trajets" -- Needs review
...
private.L["CONFIG_LOCKSWAP_DESC"] = "Survoler l'index des mobs avec la souris le déplace. Maintenir <Shift> empêche le mouvement." -- Needs review
private.L["CONFIG_SETCOLOR"] = "Couleurs des trajets" -- Needs review
private.L["CONFIG_SETCOLOR_DESC"] = "Définir les couleurs de l'index et des trajets de la carte." -- Needs review
