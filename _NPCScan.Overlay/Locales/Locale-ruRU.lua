...
private.L["BUTTON_TOOLTIP_LINE2"] = "|cffd6ff00 Щелчок: |r Переключить отображение путей на карте мира"
private.L["BUTTON_TOOLTIP_LINE3"] = "|cffd6ff00 Shift+щелчок: |r Переключить отображение списка редких существ на карте мира"
private.L["BUTTON_TOOLTIP_LINE4"] = "|cffd6ff00 Щелчок правой кнопкой: |r Переключить отображение путей на миникарте"
private.L["BUTTON_TOOLTIP_LINE5"] = "|cffaaf200 Щелчок средней кнопкой: |r Переключить отображение путей на миникарте и карте мира"
...
private.L["CONFIG_DESC"] = "Выбор карт, на которых будут показаны пути существ.  Большинство дополнений, модифицирующих карты, управляются функцией \"Карта мира\"."
...
private.L["CONFIG_SHOWALL_DESC"] = "Обычно, когда за существом не идет слежение, его путь не отображается на карте. Включите данную функцию, чтобы отображать все известные пути."
...
private.L["MODULE_WORLDMAP_KEYTOGGLE_DESC"] = "Включить/выключить показ путей"
private.L["MODULE_WORLDMAP_TOGGLE"] = "НИПы"
private.L["MODULE_WORLDMAP_TOGGLE_DESC"] = "Включить/выключить показ путей _|cffCCCC88NPCScan|r.Overlay для отслеживаемых НИПов."
