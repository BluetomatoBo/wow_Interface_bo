...
function Auras:GetAuraList()
	local auraTable = setmetatable({
		...
		[GetSpellInfo(50541)]	= 5,	-- Clench (Scorpid)
		[GetSpellInfo(90327)]	= 5,	-- Lock Jaw (Dog)
		[GetSpellInfo(50245)]	= 5,	-- Pin (Crab)
		[GetSpellInfo(91644)]	= 5,	-- Snatch (Bird of Prey)
		[GetSpellInfo(54706)]	= 5,	-- Venom Web Spray (Silithid)
		[GetSpellInfo(4167)]	= 5,	-- Web (Spider)
		[GetSpellInfo(118093)]	= 5,	-- Disarm (Voidwalker/Voidlord)
		...
		[GetSpellInfo(113275)]	= 5,	-- Entangling Roots (Symbiosis)
		[GetSpellInfo(19975)]	= 5,	-- Entangling Roots (Nature's Grasp)
		...
		[GetSpellInfo(110693)]	= 5,	-- Frost Nova (Symbiosis)
		[GetSpellInfo(102051)]	= 5,	-- Frostjaw
		[GetSpellInfo(117368)]	= 5,	-- Grapple Weapon
		[GetSpellInfo(126458)]	= 5,	-- Grapple Weapon (Symbiosis)
		[GetSpellInfo(137461)]	= 5,	-- Ring of Peace (Disarm)
		[GetSpellInfo(64058)]	= 5,	-- Psychic Horror (Disarm)
		[GetSpellInfo(123407)]	= 5,	-- Spinning Fire Blossom
		...
		[GetSpellInfo(114238)]	= 8,	-- Fae Silence (Glyphed)
		[GetSpellInfo(55021)]	= 8,	-- Improved Counterspell
		[GetSpellInfo(24259)]	= 8,	-- Spell Lock (Fel Hunter)
		[GetSpellInfo(115782)]	= 8,	-- Optical Blast (Observer)
		...
		[GetSpellInfo(137460)]	= 8,	-- Ring of Peace (Silence)
		...
		[GetSpellInfo(90337)]	= 9,	-- Bad Manner (Monkey)
		[GetSpellInfo(126423)]	= 9,	-- Petrifying Gaze (Basilisk)
		[GetSpellInfo(56626)]	= 9,	-- Sting (Wasp pet)
		[GetSpellInfo(102795)]	= 9,	-- Bear Hug (Windwalker Monk Symbiosis)
		[GetSpellInfo(105421)]	= 9,	-- Blinding Light
		[GetSpellInfo(115752)]	= 9,	-- Blinding Light (Glyphed)
		[GetSpellInfo(118271)]	= 9,	-- Combustion
		[GetSpellInfo(7922)]	= 9,	-- Charge Stun
		[GetSpellInfo(119392)]	= 9,	-- Charging Ox Wave
		[GetSpellInfo(1833)]	= 9,	-- Cheap Shot
		[GetSpellInfo(122242)]	= 9,	-- Clash
		...
		[GetSpellInfo(110698)]	= 9,	-- Hammer of Justice (Symbiosis)
		...
		[GetSpellInfo(126246)]	= 9,	-- Lullaby (Crane)
		[GetSpellInfo(96201)]	= 9,	-- Web Wrap (Shale Spider)
		[GetSpellInfo(22570)]	= 9,	-- Maim
		[GetSpellInfo(5211)]	= 9,	-- Mighty Bash
		[GetSpellInfo(113801)]	= 9,	-- Bash (Treants)
		[GetSpellInfo(126451)]	= 9,	-- Clash (Symbiosis)
		[GetSpellInfo(113953)]	= 9,	-- Paralysis
		[GetSpellInfo(126355)]	= 9,	-- Paralyzing Quill (Porcupine)
		[GetSpellInfo(9005)]	= 9,	-- Pounce
		[GetSpellInfo(102546)]	= 9,	-- Pounce (Incarnation)
		...
		[GetSpellInfo(50519)]	= 9,	-- Sonic Blast (Bat)
		...
		[GetSpellInfo(113506)]	= 10,	-- Cyclone (Symbiosis)
		...
		[GetSpellInfo(5246)]	= 10,	-- Intimidating Shout (Main target)
		[GetSpellInfo(20511)]	= 10,	-- Intimidating Shout (Secondary targets)
		[GetSpellInfo(113004)]	= 10,	-- Intimidating Roar (Symbiosis Main target)
		[GetSpellInfo(113056)]	= 10,	-- Intimidating Roar (Symbiosis Secondary targets)
		...
		[GetSpellInfo(145067)]	= 10,	-- Turn Evil (Evil is a Point of View)
