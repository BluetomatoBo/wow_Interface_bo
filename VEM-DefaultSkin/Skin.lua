...
-- DBT templates work by providing a set of DBT options which control the look and feel of the status bars. The VEM 5.0 skinning system consists of two parts:
...
skin.defaults = {
	...
	Template = "VEMDefaultSkinTimerTemplate",
	...
	Texture = "Interface\\AddOns\\VEM-DefaultSkins\\textures\\default.tga",
}
