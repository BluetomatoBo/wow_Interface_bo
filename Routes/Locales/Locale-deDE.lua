...
L["Are you sure you want to recreate this route? This will delete all customized settings for this route."] = "Bist du sicher die Route neuerzeugen zu wollen? Das löscht alle angepassten Einstellungen für diese Route." -- Needs review
...
L["Create Bare Route"] = "Erstelle leere Route" -- Needs review
...
L["Create Route from Data Sources"] = "Zeuge Route aus Datenquellen" -- Needs review
L["CREATE_ROUTE_TEXT"] = [=[
...
L["GatherMate2Logging"] = "Holzfällen" -- Needs review
...
L["Recreate Route"] = "Neuerstellen der Route" -- Needs review
L["Recreate this route with the same creation settings. NOTE: This only works for data from GatherMate2 and Gatherer."] = "Neuerstellen dieser Route mit den gleichen Einstellungen. Anmerkung: Das funktioniert nur mit Daten von GatherMate2 und Gatherer." -- Needs review
...
L["Save route edit"] = "Speicher Routenbearbeitung" -- Needs review
...
L["Stop editing this route on the world map and abandon changes made"] = "Stoppe das bearbeiten der Route auf der Weltkarte und verwerfe die gemachte Änderungen" -- Needs review
L["Stop editing this route on the world map and save the edits"] = "Stoppe das bearbeiten der Route auf der Weltkarte und speicher die Bearbeitungen" -- Needs review
