...
--	countdownReflection:Start(-delay)
	sndWOP:Schedule(21-delay, "Interface\\AddOns\\"..DBM.Options.CountdownVoice.."\\mobsoon.mp3") --準備小怪
	sndWOP:Schedule(22.5-delay, "Interface\\AddOns\\"..DBM.Options.CountdownVoice.."\\countthree.mp3")
	sndWOP:Schedule(23.5-delay, "Interface\\AddOns\\"..DBM.Options.CountdownVoice.."\\counttwo.mp3")
	sndWOP:Schedule(24.5-delay, "Interface\\AddOns\\"..DBM.Options.CountdownVoice.."\\countone.mp3")
	timerCorruptedPrisonCD:Start(-delay)
	sndWOP:Schedule(40-delay, "Interface\\AddOns\\"..DBM.Options.CountdownVoice.."\\readyrescue.mp3") --準備救人
	timerManifestationCD:Start(-delay)
	sndWOP:Schedule(60-delay, "Interface\\AddOns\\"..DBM.Options.CountdownVoice.."\\bigmobsoon.mp3") --準備大怪
	specWarnManifestation:Schedule(64-delay)
	if mod:IsDps() then
		sndWOP:Schedule(64-delay, "Interface\\AddOns\\"..DBM.Options.CountdownVoice.."\\killbigmob.mp3")--大怪快打
	else
		sndWOP:Schedule(64-delay, "Interface\\AddOns\\"..DBM.Options.CountdownVoice.."\\bigmob.mp3")--大怪出現
	end
	timerSwellingPrideCD:Start(-delay, 1)
--	countdownSwellingPride:Start(-delay)
	sndWOP:Schedule(72.5-delay, "Interface\\AddOns\\"..DBM.Options.CountdownVoice.."\\aesoon.mp3") --準備AOE
	sndWOP:Schedule(73.5-delay, "Interface\\AddOns\\"..DBM.Options.CountdownVoice.."\\countthree.mp3")
	sndWOP:Schedule(74.5-delay, "Interface\\AddOns\\"..DBM.Options.CountdownVoice.."\\counttwo.mp3")
	sndWOP:Schedule(75.5-delay, "Interface\\AddOns\\"..DBM.Options.CountdownVoice.."\\countone.mp3")
	...
	if args.spellId == 144400 then
		...
		if MyJS() then
			...
			if (playerpower >= 50) and (playerpower < 75) then
				sndWOP:Play("Interface\\AddOns\\"..DBM.Options.CountdownVoice.."\\ex_so_zbty.mp3") --準備投影
...
--		countdownReflection:Start()
		sndWOP:Cancel("Interface\\AddOns\\"..DBM.Options.CountdownVoice.."\\mobsoon.mp3")
		sndWOP:Schedule(21, "Interface\\AddOns\\"..DBM.Options.CountdownVoice.."\\mobsoon.mp3") --準備小怪
		sndWOP:Schedule(22.5, "Interface\\AddOns\\"..DBM.Options.CountdownVoice.."\\countthree.mp3")
		sndWOP:Schedule(23.5, "Interface\\AddOns\\"..DBM.Options.CountdownVoice.."\\counttwo.mp3")
		sndWOP:Schedule(24.5, "Interface\\AddOns\\"..DBM.Options.CountdownVoice.."\\countone.mp3")
		timerCorruptedPrisonCD:Start()
		sndWOP:Cancel("Interface\\AddOns\\"..DBM.Options.CountdownVoice.."\\readyrescue.mp3")
		sndWOP:Schedule(40, "Interface\\AddOns\\"..DBM.Options.CountdownVoice.."\\readyrescue.mp3") --準備救人			
		if self:IsDifficulty("heroic10", "heroic25") then
...
--		countdownReflection:Start()
		...
		sndWOP:Schedule(60, "Interface\\AddOns\\"..DBM.Options.CountdownVoice.."\\bigmobsoon.mp3") --準備大怪
		specWarnManifestation:Schedule(64)
		if mod:IsDps() then
			sndWOP:Schedule(64, "Interface\\AddOns\\"..DBM.Options.CountdownVoice.."\\killbigmob.mp3")--大怪快打
		else
			sndWOP:Schedule(64, "Interface\\AddOns\\"..DBM.Options.CountdownVoice.."\\bigmob.mp3")--大怪出現
		end		
		timerSwellingPrideCD:Start(75, swellingCount + 1)
--		countdownSwellingPride:Start()
		sndWOP:Schedule(72.5, "Interface\\AddOns\\"..DBM.Options.CountdownVoice.."\\aesoon.mp3") --準備AOE
		sndWOP:Schedule(73.5, "Interface\\AddOns\\"..DBM.Options.CountdownVoice.."\\countthree.mp3")
		sndWOP:Schedule(74.5, "Interface\\AddOns\\"..DBM.Options.CountdownVoice.."\\counttwo.mp3")
		sndWOP:Schedule(75.5, "Interface\\AddOns\\"..DBM.Options.CountdownVoice.."\\countone.mp3")
		if self:IsDifficulty("heroic10", "heroic25") then
			timerBanishmentCD:Start()
		end
...
--		countdownSwellingPride:Cancel()
		...
		specWarnManifestation:Schedule(64)
		sndWOP:Cancel("Interface\\AddOns\\"..DBM.Options.CountdownVoice.."\\bigmobsoon.mp3")		
		sndWOP:Schedule(60, "Interface\\AddOns\\"..DBM.Options.CountdownVoice.."\\bigmobsoon.mp3") --準備大怪		
		if mod:IsDps() then
			sndWOP:Cancel("Interface\\AddOns\\"..DBM.Options.CountdownVoice.."\\killbigmob.mp3")
			sndWOP:Schedule(64, "Interface\\AddOns\\"..DBM.Options.CountdownVoice.."\\killbigmob.mp3")--大怪快打
		else
			sndWOP:Cancel("Interface\\AddOns\\"..DBM.Options.CountdownVoice.."\\bigmob.mp3")
			sndWOP:Schedule(64, "Interface\\AddOns\\"..DBM.Options.CountdownVoice.."\\bigmob.mp3")--大怪出現
		end
...
--		countdownSwellingPride:Start(75)--Not yet verified if altered or not (it would be 62 instead of 60 though since we'd be starting at 0 energy instead of cast finish of last swelling)
		sndWOP:Schedule(72, "Interface\\AddOns\\"..DBM.Options.CountdownVoice.."\\aesoon.mp3") --準備AOE
		sndWOP:Schedule(73, "Interface\\AddOns\\"..DBM.Options.CountdownVoice.."\\countthree.mp3")
		sndWOP:Schedule(74, "Interface\\AddOns\\"..DBM.Options.CountdownVoice.."\\counttwo.mp3")
		sndWOP:Schedule(75, "Interface\\AddOns\\"..DBM.Options.CountdownVoice.."\\countone.mp3")
...
function mod:SPELL_AURA_APPLIED(args)
	if args:IsSpellID(144359, 146594) then
		...
		if args:IsPlayer() then
			...
			sndWOP:Play("Interface\\AddOns\\"..DBM.Options.CountdownVoice.."\\ex_so_ttzc.mp3") --泰坦之賜
			if mod:IsHealer() then
				sndWOP:Schedule(1, "Interface\\AddOns\\"..DBM.Options.CountdownVoice.."\\dispelnow.mp3") --快驅散
			else
				sndWOP:Schedule(1, "Interface\\AddOns\\"..DBM.Options.CountdownVoice.."\\gather.mp3") --快集合
			end
			TTbuff = true
		end
	elseif args.spellId == 145215 then
		...
		if args:IsPlayer() then
			...
			sndWOP:Play("Interface\\AddOns\\"..DBM.Options.CountdownVoice.."\\banishment.mp3") --你被放逐
		end
	elseif args.spellId == 146822 then
		...
		if args:IsPlayer() then
			...
			sndWOP:Play("Interface\\AddOns\\"..DBM.Options.CountdownVoice.."\\ex_so_kjty.mp3") --快進投影
			sndWOP:Schedule(1, "Interface\\AddOns\\"..DBM.Options.CountdownVoice.."\\ex_so_kjty.mp3")
			sndWOP:Schedule(2, "Interface\\AddOns\\"..DBM.Options.CountdownVoice.."\\countfive.mp3")
			sndWOP:Schedule(3, "Interface\\AddOns\\"..DBM.Options.CountdownVoice.."\\countfour.mp3")
	...
	elseif args.spellId == 144843 then--Same spellid fires for both versions, so we have to do some more advanced filtering
		if bit.band(args.destFlags, COMBATLOG_OBJECT_REACTION_HOSTILE) ~= 0 then--Mind controled version
			...
			if args:IsPlayer() then
				...
				sndWOP:Play("Interface\\AddOns\\"..DBM.Options.CountdownVoice.."\\ex_so_aqym.mp3") --傲氣已滿
			end
		end
	...
	if args:IsPlayerSource() then
		self:Schedule(7.5, function()
			if mod:IsHealer() and TTbuff then
				sndQS:Play("Interface\\AddOns\\"..DBM.Options.CountdownVoice.."\\dispelnow.mp3") --快驅散
			end
		end)
	end
end
...
function mod:UNIT_POWER(uId)
	...
	if playerpower >= 75 and not warnedpowerhigh then
		sndWOP:Play("Interface\\AddOns\\"..DBM.Options.CountdownVoice.."\\ex_so_aqgg.mp3") --傲氣過高
		sndWOP:Schedule(1, "Interface\\AddOns\\"..DBM.Options.CountdownVoice.."\\runout.mp3") --離開人群
		if self.Options.RangeFrame then
