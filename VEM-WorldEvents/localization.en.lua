...
------------------------------
L = VEM:GetModLocalization("Greench")
...
--  Plants Vs. Zombies  --
--------------------------
L = VEM:GetModLocalization("PlantsVsZombies")
