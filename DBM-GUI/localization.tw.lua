...
L.SKT_Enabled				= "總是顯示最速勝利計時條(覆蓋首領特定的選項)"
...
L.SpecWarn_LHFrame			= "特別警告時屏幕邊緣泛光"
L.SpecWarn_AdSound			= "啟用特別警告高級聲音選項（需要UI重載）"
L.SpecWarn_FlashFrame		= "為毀滅性技能震動屏幕"
