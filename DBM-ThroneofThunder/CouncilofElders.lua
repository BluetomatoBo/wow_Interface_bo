...
function mod:OnCombatStart(delay)
	...
	sndLS:Schedule(3, "Interface\\AddOns\\"..DBM.Options.CountdownVoice.."\\ex_tt_lszb.mp3") --流沙準備
	sndLS:Schedule(4, "Interface\\AddOns\\"..DBM.Options.CountdownVoice.."\\countthree.mp3")
	sndLS:Schedule(5, "Interface\\AddOns\\"..DBM.Options.CountdownVoice.."\\counttwo.mp3")
	sndLS:Schedule(6, "Interface\\AddOns\\"..DBM.Options.CountdownVoice.."\\countone.mp3")
	...
	sndSpirit:Schedule(21, "Interface\\AddOns\\"..DBM.Options.CountdownVoice.."\\ghostsoon.mp3")
	sndSpirit:Schedule(22, "Interface\\AddOns\\"..DBM.Options.CountdownVoice.."\\countthree.mp3")
	sndSpirit:Schedule(23, "Interface\\AddOns\\"..DBM.Options.CountdownVoice.."\\counttwo.mp3")
	sndSpirit:Schedule(24, "Interface\\AddOns\\"..DBM.Options.CountdownVoice.."\\countone.mp3")
...
function mod:SPELL_CAST_START(args)
	...
	elseif args.spellId == 136521 and args:GetSrcCreatureID() == 69078 then--Filter the ones cast by adds dying.
		...
		sndLS:Cancel("Interface\\AddOns\\"..DBM.Options.CountdownVoice.."\\countthree.mp3")
		sndLS:Cancel("Interface\\AddOns\\"..DBM.Options.CountdownVoice.."\\counttwo.mp3")
		sndLS:Cancel("Interface\\AddOns\\"..DBM.Options.CountdownVoice.."\\countone.mp3")
		sndLS:Schedule(1, "Interface\\AddOns\\"..DBM.Options.CountdownVoice.."\\ex_tt_zyls.mp3")
		sndLS:Schedule(29, "Interface\\AddOns\\"..DBM.Options.CountdownVoice.."\\ex_tt_lszb.mp3") --流沙準備
		sndLS:Schedule(30, "Interface\\AddOns\\"..DBM.Options.CountdownVoice.."\\countthree.mp3")
		sndLS:Schedule(31, "Interface\\AddOns\\"..DBM.Options.CountdownVoice.."\\counttwo.mp3")
		sndLS:Schedule(32, "Interface\\AddOns\\"..DBM.Options.CountdownVoice.."\\countone.mp3")
	elseif args.spellId == 136894 then
		warnSandstorm:Show()
		specWarnSandStorm:Show()
		sndWOP:Play("Interface\\AddOns\\"..DBM.Options.CountdownVoice.."\\ex_tt_scfb.mp3")  --沙塵風暴
	...
	elseif args.spellId == 137203 then
		...
		sndSpirit:Play("Interface\\AddOns\\"..DBM.Options.CountdownVoice.."\\killspirit.mp3")
		sndSpirit:Cancel("Interface\\AddOns\\"..DBM.Options.CountdownVoice.."\\countthree.mp3")
		sndSpirit:Cancel("Interface\\AddOns\\"..DBM.Options.CountdownVoice.."\\counttwo.mp3")
		sndSpirit:Cancel("Interface\\AddOns\\"..DBM.Options.CountdownVoice.."\\countone.mp3")
		sndSpirit:Schedule(29, "Interface\\AddOns\\"..DBM.Options.CountdownVoice.."\\ghostsoon.mp3")
		sndSpirit:Schedule(30, "Interface\\AddOns\\"..DBM.Options.CountdownVoice.."\\countthree.mp3")
		sndSpirit:Schedule(31, "Interface\\AddOns\\"..DBM.Options.CountdownVoice.."\\counttwo.mp3")
		sndSpirit:Schedule(32, "Interface\\AddOns\\"..DBM.Options.CountdownVoice.."\\countone.mp3")
	...
	elseif args.spellId == 136990 then
		...
		sndHS:Play("Interface\\AddOns\\"..DBM.Options.CountdownVoice.."\\ex_tt_zyjt.mp3")
	--BH ADD END
	end
end
...
function mod:SPELL_AURA_APPLIED(args)
	if args.spellId == 136442 then--Possessed
		...
		if cid == 69078 then--Sul the Sandcrawler
			...
			speedcheck = Sulcount
			if mod:IsDps() then
				sndWOP:Play("Interface\\AddOns\\"..DBM.Options.CountdownVoice.."\\ex_tt_sxzk.mp3")  --沙行者快打
			else
				sndWOP:Play("Interface\\AddOns\\"..DBM.Options.CountdownVoice.."\\ex_tt_sxz.mp3") 	 --沙行者強化
			end
			--BH ADD END
		...
		elseif cid == 69132 then--High Prestess Mar'li
			...
			if mod:IsDps() then
				sndWOP:Play("Interface\\AddOns\\"..DBM.Options.CountdownVoice.."\\ex_tt_njsk.mp3")  --女祭祀快打
			else
				sndWOP:Play("Interface\\AddOns\\"..DBM.Options.CountdownVoice.."\\ex_tt_njs.mp3") 	 --女祭祀強化
			end
			--BH ADD END
		...
		elseif cid == 69131 then--Frost King Malakk
			...
			speedcheck = Malcount
			if mod:IsDps() then
				sndWOP:Play("Interface\\AddOns\\"..DBM.Options.CountdownVoice.."\\ex_tt_shwk.mp3")	--霜王快打
			else
				sndWOP:Play("Interface\\AddOns\\"..DBM.Options.CountdownVoice.."\\ex_tt_shw.mp3")	--霜王強化
			end
			--BH ADD END
			--Swap timers. While possessed 
			...
			if elapsed and total and total ~= 0 then--If for some reason it was nil, like it JUST came off cd, do nothing, he should cast frost bite right away.
				...
				sndHS:Schedule(total-elapsed-3.5, "Interface\\AddOns\\"..DBM.Options.CountdownVoice.."\\ex_tt_hszb.mp3") --寒霜準備
			end
		...
		elseif cid == 69134 then--Kazra'jin
			...
			speedcheck = Kazcount
			if mod:IsDps() then
				sndWOP:Play("Interface\\AddOns\\"..DBM.Options.CountdownVoice.."\\ex_tt_ljrk.mp3")  --綠巨人快打
			else
				sndWOP:Play("Interface\\AddOns\\"..DBM.Options.CountdownVoice.."\\ex_tt_ljr.mp3") 	 --綠巨人強化
			end
			--BH ADD END
			dischargeCount = 0
			kazraPossessed = true
	...
	elseif args.spellId == 136992 then--Player Debuff version, not cast version
		...
		if args:IsPlayer() then
			...
			sndWOP:Play("Interface\\AddOns\\"..DBM.Options.CountdownVoice.."\\runout.mp3") --離開人群 (刺骨之寒)
			yellBitingCold:Yell()
		end
		--BH ADD
	...
	elseif args.spellId == 136922 and (args.amount or 1) == 1 then--Player Debuff version, not cast version (amount is just a spam filter for ignoring SPELL_AURA_APPLIED_DOSE on this event)
		...
		sndHS:Schedule(42, "Interface\\AddOns\\"..DBM.Options.CountdownVoice.."\\ex_tt_hszb.mp3") --寒霜準備
		if args:IsPlayer() then
			specWarnFrostBite:Show()
			timerFrostBite:Start()
			sndWOP:Play("Interface\\AddOns\\"..DBM.Options.CountdownVoice.."\\ex_tt_zrkj.mp3") --找人靠近 (寒霜刺骨)
		else
			if mod:IsRanged() then
				sndWOP:Play("Interface\\AddOns\\"..DBM.Options.CountdownVoice.."\\ex_tt_jhfd.mp3")
			end
		end
		--BH ADD
	...
	elseif args:IsSpellID(136860, 136878) and args:IsPlayer() and self:AntiSpam(2, 3) then--Trigger off initial quicksand debuff and ensnared stacks. much less cpu them registering damage events and just as effective.
		...
		sndWOP:Play("Interface\\AddOns\\"..DBM.Options.CountdownVoice.."\\ex_tt_xj.mp3") --陷阱跑開
	...
	elseif args.spellId == 137650 then --幽暗碎片
		...
		if args:IsPlayer() then
			if (args.amount or 1) >= OCn then
				...
				sndWOP:Play("Interface\\AddOns\\"..DBM.Options.CountdownVoice.."\\transplague.mp3")
			end
		end
...
function mod:SPELL_AURA_REMOVED(args)
	if args.spellId == 136442 then--Possessed
		...
		elseif args:GetDestCreatureID() == 69131 then--Frost King Malakk
			...
			sndHS:Cancel("Interface\\AddOns\\"..DBM.Options.CountdownVoice.."\\ex_tt_hszb.mp3")
...
function mod:UNIT_DIED(args)
	...
	if cid == 69078 then--Sul the Sandcrawler
		timerSandStormCD:Cancel()
		sndLS:Cancel("Interface\\AddOns\\"..DBM.Options.CountdownVoice.."\\ex_tt_lszb.mp3")
		sndLS:Cancel("Interface\\AddOns\\"..DBM.Options.CountdownVoice.."\\countthree.mp3")
		sndLS:Cancel("Interface\\AddOns\\"..DBM.Options.CountdownVoice.."\\counttwo.mp3")
		sndLS:Cancel("Interface\\AddOns\\"..DBM.Options.CountdownVoice.."\\countone.mp3")
	elseif cid == 69132 then--High Prestess Mar'li
...
function mod:OnSync(msg, guid)
	if msg == "mycold" and guid then
		if guid == mod.Options.helpcold then
			sndWOP:Schedule(5, "Interface\\AddOns\\"..DBM.Options.CountdownVoice.."\\ex_tt_twjs.mp3")
		end
	end
end
--BH ADD END