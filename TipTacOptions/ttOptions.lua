...
local options = {
	...
	-- Colors
	{
		...
		{ type = "Color", subType = 2, var = "colSameGuild", label = "Your Guild Color", tip = "To better recognise players from your guild, you can configure the color of your guild name individually", y = 16 },
	...
	-- Font
	{
		...
		{ type = "Slider", var = "fontSizeDelta", label = "Font Size Delta", min = -10, max = 10, step = 1 },
	},
	-- Classify
	{
		[0] = "Classify",
