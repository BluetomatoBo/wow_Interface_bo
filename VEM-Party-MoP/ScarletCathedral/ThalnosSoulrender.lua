local mod	= VEM:NewMod(688, "VEM-Party-MoP", 9, 316)
...
function mod:SPELL_CAST_SUCCESS(args)
	...
	elseif args.spellId == 115147 then--Summon Empowering Spirits
		...
		sndWOP:Play("Interface\\AddOns\\VEM-Core\\extrasounds\\"..VEM.Options.CountdownVoice.."\\killspirit.mp3") --靈魂快打
		timerRaiseCrusadeCD:Start(20)--Raise crusaders always 20 seconds after spirits in all modes
		sndWOP:Schedule(19, "Interface\\AddOns\\VEM-Core\\extrasounds\\"..VEM.Options.CountdownVoice.."\\mobsoon.mp3") --準備小怪
