local mod	= VEM:NewMod(654, "VEM-Party-MoP", 8, 311)
...
function mod:OnCombatStart(delay)
	...
	sndWOP:Schedule(20, "Interface\\AddOns\\VEM-Core\\extrasounds\\"..VEM.Options.CountdownVoice.."\\mobsoon.mp3")--準備小怪
...
function mod:SPELL_CAST_START(args)
	if args.spellId == 111216 then
		...
		sndWOP:Play("Interface\\AddOns\\VEM-Core\\extrasounds\\"..VEM.Options.CountdownVoice.."\\wwsoon.mp3")--準備旋風
