local mod	= VEM:NewMod(335, "VEM-Party-MoP", 1, 313)
...
function mod:OnCombatStart(delay)
	...
	sndWOP:Schedule(18.5, "Interface\\AddOns\\VEM-Core\\extrasounds\\"..VEM.Options.CountdownVoice.."\\countfour.mp3")
	sndWOP:Schedule(19.5, "Interface\\AddOns\\VEM-Core\\extrasounds\\"..VEM.Options.CountdownVoice.."\\countthree.mp3")
	sndWOP:Schedule(20.5, "Interface\\AddOns\\VEM-Core\\extrasounds\\"..VEM.Options.CountdownVoice.."\\counttwo.mp3")
	sndWOP:Schedule(21.5, "Interface\\AddOns\\VEM-Core\\extrasounds\\"..VEM.Options.CountdownVoice.."\\countone.mp3")
end
