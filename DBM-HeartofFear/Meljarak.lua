...
function mod:SPELL_AURA_APPLIED(args)
	if args:IsSpellID(122224, 61721) and args.sourceName == UnitName("player") then
		...
		sndDS:Cancel("Interface\\AddOns\\DBM-Core\\extrasounds\\ex_mop_kzjs.mp3")
		...
		sndDS:Cancel("Interface\\AddOns\\DBM-Core\\extrasounds\\countseven.mp3")
		sndDS:Cancel("Interface\\AddOns\\DBM-Core\\extrasounds\\countsix.mp3")
		sndDS:Cancel("Interface\\AddOns\\DBM-Core\\extrasounds\\countfive.mp3")	
		sndDS:Cancel("Interface\\AddOns\\DBM-Core\\extrasounds\\countfour.mp3")	
		sndDS:Cancel("Interface\\AddOns\\DBM-Core\\extrasounds\\countthree.mp3")
		sndDS:Cancel("Interface\\AddOns\\DBM-Core\\extrasounds\\counttwo.mp3")
		sndDS:Cancel("Interface\\AddOns\\DBM-Core\\extrasounds\\countone.mp3")
		sndDS:Cancel("Interface\\AddOns\\DBM-Core\\extrasounds\\ex_mop_kzjs.mp3")
		sndDS:Schedule(30, "Interface\\AddOns\\DBM-Core\\extrasounds\\ex_mop_kzjs.mp3") --控制即將結束	
		sndDS:Schedule(40, "Interface\\AddOns\\DBM-Core\\extrasounds\\countten.mp3")
		sndDS:Schedule(41, "Interface\\AddOns\\DBM-Core\\extrasounds\\countnine.mp3")
		sndDS:Schedule(42, "Interface\\AddOns\\DBM-Core\\extrasounds\\counteight.mp3")	
		sndDS:Schedule(43, "Interface\\AddOns\\DBM-Core\\extrasounds\\countseven.mp3")
		sndDS:Schedule(44, "Interface\\AddOns\\DBM-Core\\extrasounds\\countsix.mp3")
		sndDS:Schedule(45, "Interface\\AddOns\\DBM-Core\\extrasounds\\countfive.mp3")	
		sndDS:Schedule(46, "Interface\\AddOns\\DBM-Core\\extrasounds\\countfour.mp3")	
		sndDS:Schedule(47, "Interface\\AddOns\\DBM-Core\\extrasounds\\countthree.mp3")
		sndDS:Schedule(48, "Interface\\AddOns\\DBM-Core\\extrasounds\\counttwo.mp3")
		sndDS:Schedule(49, "Interface\\AddOns\\DBM-Core\\extrasounds\\countone.mp3")	
	...
	if msg == "KorthikStrikeTarget" and guids[guid] then
		...
		if ((mod.Options.optBH == "BH1") and (cfcount % 4 == 1)) or ((mod.Options.optBH == "BH2") and (cfcount % 4 == 2)) or ((mod.Options.optBH == "BH3") and (cfcount % 4 == 3)) or ((mod.Options.optBH == "BH4") and (cfcount % 4 == 0)) then
			if guid ~= UnitGUID("player") then--make sure YOU aren't target before warning "other"
				...
				sndWOP:Play("Interface\\AddOns\\DBM-Core\\extrasounds\\ex_mop_kgbh.mp3") --快給保護
			end
