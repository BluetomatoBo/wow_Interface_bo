...
function VUF:ConstructEclipseBar(frame)
    ...
    local function ConfigureEclipseBar(name)
        ...
        local sbname = frame.unit..'_vuf_classbars_'..name
...
-- Totems for shamans
function VUF:ConstructTotems(frame)
...
function VUF:ConstructComboPoints(frame)
    ...
    bars.Override = VUF.ComboDisplay
    
    frame:RegisterEvent("UNIT_DISPLAYPOWER", VUF.ComboDisplay)
    return bars
end
