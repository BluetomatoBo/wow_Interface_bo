...
L["Enable the Vertical Unit Frames."] = "Activer le Vertical Unit Frame"
...
L["Vertical Unit Frame Options"] = "Options du Vertical Unit Frame"
...
L["Set the Alpha of the Vertical Unit Frame when out of combat"] = "Régler la transparence du Vertical Unit Frame hors combat"
...
L["Player Vertical Unit Frame"] = "Vertical Unit Frame du Joueur"
L["Target Vertical Unit Frame"] = "Vertical Unit Frame de la cible"
L["Pet Vertical Unit Frame"] = "Vertical Unit Frame du familier"
L["Target Target Vertical Unit Frame"] = "Vertical Unit Frame de la cible de la cible"
L["Pet Target Vertical Unit Frame"] = "Vertical Unit Frame de la cible du familier"
...
L['ElvUI VerticalUnitFrames by Sortokk'] = true
L['ElvUI VerticalUnitFrames provides a configurable centered, vertical unit frame option for use with ElvUI.\n'] = "Le Vertical Unit Frame de ElvUI est un affichage tête haute utilisable avec ElvUI.\n"
...
L['Hide the ElvUI Unitframes when the Vertical Unit Frame is enabled'] = "Cacher les cadres d'unités d'ElvUI lorsque le Vertical Unit Frame est activé"
L['Hide the Vertical Unit Frame when out of Combat'] = "Cacher le Vertical Unit Frame lorsque le joueur est hors combat"
L['Hide Out of Combat'] = "Cacher hors combat"
L['Enable Mouse'] = "Activer la souris"
L['Enable the mouse to interface with the vertical unit frame (this option has no effect if ElvUI Unitframes are hidden)'] = "Autoriser l'interaction de la souris avec le Vertical Unit Frame (cette option n'a aucun effet si les cadres d'unités de ElvUI sont cachés"
L['Set the Alpha of the Vertical Unit Frame when in combat'] = "Configurer la transparence du Vertical Unit Frame en combat"
...
L['Value'] = true
L['Default'] = true
L["ElvUI_VerticalUnitFrames_CREDITS"] = [[Remerciement aux personnes suivantes :

Tukz pour ces cadres d'unites qui ont été la base de ce vuf.
...
L["Here you can choose between the simple layout (only player health and power) or the default layout for the Vertical Unit Frame"] = true
