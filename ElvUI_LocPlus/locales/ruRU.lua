...
L["Enable/Disable Datatext Panels. Choose the value, in ElvUI DataTexts section"] = "Включить/выключить панели инфо текстов. Отображаемая информация выбирается в соответственной секции настроек ElvUI."
...
L["Enable/Disable the coords for area and recommended dungeon entrances, on Tooltip."] = "Включить/выключить координаты входов в подземелья для рекомендованных подземелий и подземелий текущей локации."
...
L["LocationPlus Datatexts are disabled. Please go to the options to re-enable them."] = "Информационные тексты LocationPlus отключены. Пожалуйста, зайдите в опции для их активации."
...
L["Show Dungeon Entrances Coords"] = "Показывать соокрдинаты входов в подземелья"
L["Show Fishing level"] = "Навык рыбалки"
