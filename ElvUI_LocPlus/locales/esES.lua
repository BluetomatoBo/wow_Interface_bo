...
L["Enable/Disable Datatext Panels. Choose the value, in ElvUI DataTexts section"] = "Enable/Disable Datatext Panels. Choose the value, in ElvUI DataTexts section" -- Requires localization
...
L["Enable/Disable the coords for area and recommended dungeon entrances, on Tooltip."] = "Enable/Disable the coords for area and recommended dungeon entrances, on Tooltip." -- Requires localization
...
L["LocationPlus Datatexts are disabled. Please go to the options to re-enable them."] = "LocationPlus Datatexts are disabled. Please go to the options to re-enable them." -- Requires localization
...
L["Show Dungeon Entrances Coords"] = "Show Dungeon Entrances Coords" -- Requires localization
L["Show Fishing level"] = "Show Fishing level" -- Requires localization
...
L["Show/Hide raids or dungeons."] = "Show/Hide raids or dungeons." -- Requires localization
L["Show/Hide tooltip"] = "Show/Hide tooltip" -- Requires localization
L["Show Hints"] = "Show Hints" -- Requires localization
L["Show Level Range"] = "Show Level Range" -- Requires localization
