...
local mod	= VEM:NewMod("d594", "VEM-Scenario-MoP")
...
--Essence of Order
--Todo, maybe register COMBAT_REGEN_DISABLED and check warlocks target (basically what vem core normally does) for combat start timers?
