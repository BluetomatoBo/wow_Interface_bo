...
-- Brawlers --
--------------
L= VEM:GetModLocalization("Brawlers")
...
-- Rank 1 --
------------
L= VEM:GetModLocalization("BrawlRank1")
...
-- Rank 2 --
------------
L= VEM:GetModLocalization("BrawlRank2")
...
-- Rank 3 --
------------
L= VEM:GetModLocalization("BrawlRank3")
...
-- Rank 4 --
------------
L= VEM:GetModLocalization("BrawlRank4")
...
-- Rank 5 --
------------
L= VEM:GetModLocalization("BrawlRank5")
...
-- Rank 6 --
------------
L= VEM:GetModLocalization("BrawlRank6")
...
-- Rank 7 --
------------
L= VEM:GetModLocalization("BrawlRank7")
...
-- Rank 8 --
------------
L= VEM:GetModLocalization("BrawlRank8")
...
-- Rank 9 --
------------
L= VEM:GetModLocalization("BrawlRank9")
...
-- Rares 1 --
-------------
L= VEM:GetModLocalization("BrawlRare1")
...
-- Rares 2 --
-------------
L= VEM:GetModLocalization("BrawlRare2")
